    ...
    e.fn.cmsmastersHoverSlider = function(t) {
        ...
        o = {
            ...
            startSlider: function() {
                o.vars.sliderBlock.append('<ul class="cmsmasters_hover_slider_thumbs"></ul>');
                for (var i = 0; i < o.vars.items_img_count; i += 1) {
                    o.vars.thumbsHTML += "<li>" + '<a href="#" class="cmsmasters_hover_slider_thumb">' + '<img src="' + o.vars.items_img.eq(i).attr("src") + '" alt="" width="' + o.vars.items_thumbWidth + '" height="' + o.vars.items_thumbHeight + '" />' + "</a>" + "</li>"
                }
                o.vars.sliderBlock.find(".cmsmasters_hover_slider_thumbs").append(o.vars.thumbsHTML);
                o.vars.items.eq(o.vars.activeSlide).css({
                    visibility: "visible",
                    opacity: 1
                }).addClass("hovered_slide");
                o.vars.sliderBlock.find(".cmsmasters_hover_slider_thumbs > li").eq(o.vars.activeSlide).addClass("hovered_item");
            ...
            nextSlide: function(e) {
                ...
                o.vars.sliderBlock.find(".cmsmasters_hover_slider_thumbs > li").filter(".hovered_item").removeClass("hovered_item");
                o.vars.items.eq(e).css({
                    visibility: "visible",
                    opacity: 1
                }).addClass("hovered_slide");
                o.vars.sliderBlock.find(".cmsmasters_hover_slider_thumbs > li").eq(e).addClass("hovered_item");
            ...
            attachEvents: function() {
                ...
                r.find(e(".cmsmasters_hover_slider_thumb")).bind("mouseover", function() {
                ...
                r.find(e(".cmsmasters_hover_slider_thumb")).bind("click", function() {
                    return false
                });
