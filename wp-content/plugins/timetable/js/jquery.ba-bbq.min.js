...
! function(t, n, e) {
    ...
    t.fn[i] = function(t) {
    ...
    }, t.fn[i].delay = 50, c[i] = t.extend(c[i], {
        setup: function() {
            if (u) return !1;
            t(o.start)
        },
        ...
        function h() {
            var o = f(),
                r = p(s);
            o !== s ? (l(s = o, r), t(n).trigger(i)) : r !== s && (location.href = location.href.replace(/#.*/, "") + r), e = setTimeout(h, t.fn[i].delay)
        }
        return a.start = function() {
            e || h()
        }, a.stop = function() {
            e && clearTimeout(e), e = void 0
        }, /MSIE/.test(navigator.userAgent) && !u && (a.start = function() {
            o || (c = (c = t.fn[i].src) && c + f(), o = t('<iframe tabindex="-1" title="empty"/>').hide().one("load", function() {
                c || l(f()), h()
            }).attr("src", c || "javascript:0").insertAfter("body")[0].contentWindow, r.onpropertychange = function() {
                try {
                    "title" === event.propertyName && (o.document.title = r.title)
                } catch (t) {}
            })
        }, a.stop = d, p = function() {
            return f(o.location.href)
        }, l = function(n, e) {
            var c = o.document,
                a = t.fn[i].domain;
            n !== e && (c.title = r.title, c.open(), a && c.write('<script>document.domain="' + a + '"<\/script>'), c.close(), o.location.hash = n)
        }), a
    }()
}(jQuery, this);