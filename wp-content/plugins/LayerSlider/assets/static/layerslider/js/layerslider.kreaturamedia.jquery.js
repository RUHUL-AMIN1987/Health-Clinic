...
! function(ie) {
    ...
    }), ie.fn.layerSlider = function(i, a, s, r) {
    ...
    var n = function(L, $, i, W) {
        $.data("lsSliderUID", W).attr("data-layerslider-uid", W);
        var J = this,
        ...
        J.defaults = {
                ...
                options: function(e, t) {
                    t = {
                        is: {
                            ...
                            imageLayer: !!e.is("img.ls-layer, picture.ls-layer"),
            ...
            init: function() {
                ...
                for (var e = $.find("> .ls-layer, > .ls-slide"), t = 0, i = J.defaults.slide.keys, a = 0, s = e.length; a < s; a++) {
                    var r = ie(e[a]),
                        o = r[0].style,
                        ...
                        for (var m in n.plugins)
                            if (r.data("ls-plugin-" + m)) {
                                ...
                                for (var v = 0; v < g.length; v++) {
                                    var x, w = g[v].split(":");
                                    w[0] = ie.trim(w[0]), "" !== w[0] && (x = J.functions.convert.properties(ie.trim(w[1])), -1 === w[0].indexOf("duration") && -1 === w[0].indexOf("delay") || (x /= 1e3), y[w[0]] ? n.plugins[m][y[w[0]]] = x : n.plugins[m][w[0]] = x)
                                }
            ...
            set: {
                slideIndexes: function() {
                    var e = J.slides;
                    e.prev.index = e.current.index, e.current.index = e.next.index, e.next.index = J.slideshow.get.slideInSequence(J.slideshow.direction), e.set.slidesData(), J.slider.set.attributes(), J.slides.indexesCreated = !0
                },
            ...
            deeplink: function(e, t) {
                for (var i = !1, a = 1; a < J.slides.count + 1; a++)
                    if (J.slides[a].data.deeplink == e.substring(1)) {
                        if (i = a, t) return i;
            ...
            set: {
                ...
                smartLinks: function(e) {
                    ...
                    if (t && -1 !== t.indexOf("ls-scroll")) {
                        ...
                        J.layers.set.ariaLabel(e, i), e.on("click." + W, function(e) {
                            e.preventDefault();
                            ...
                            if (a) switch (a) {
                                ...
                                case "sliderbottom":
                                    ...
                                    break;
                                default:
                                    t = ie(a).filter(":visible").last().length ? ie(a).filter(":visible").last().offset().top : J.slider.offset.top + J.slider.height
                            }
                    ...
                    if (-1 !== J.defaults.init.controls.indexOf(a.toLowerCase()) || a.match(/^\#[0-9]/)) {
                        var s = ie.trim(a.toLowerCase().split("#")[1]),
                            r = parseInt(s);
                        switch (s) {
                            case "playmedia":
                        ...
                        J.layers.set.ariaLabel(e, i), e.on("click." + W, function(e) {
                            if (e.preventDefault(), -1 !== ["prev", "next", "last", "first", "start", "stop"].indexOf(s)) J.navigation[s]("clicked");
                            else if ("number" == typeof r && r == r) J.slideshow.changeTo(r, !0, !0);
                            else if (!J.slider.state.changingSlides) switch (s) {
                                case "replay":
                ...
                style: function(e) {
                    var t, i, a, s, r, o, n, l, d, c, p, u, h = e[0],
                        m = e.data(J.defaults.init.dataKey),
                        f = h.style,
                        g = J.layers,
                        y = null,
                        v = null,
                        ...
                        b = 0,
                        T = !1,
                        k = parseFloat(h.style.fontSize) || 36,
                        C = h.getBoundingClientRect(),
                        P = !e.is("img, picture") && window.LS_previewZoom || 1,
                        O = "" !== f.paddingLeft ? g.getStyle(f.paddingLeft, J.slider.initial.percW) : g.getStyle(e.css("padding-left"), J.slider.initial.percW),
                        I = "" !== f.paddingRight ? g.getStyle(f.paddingRight, J.slider.initial.percW) : g.getStyle(e.css("padding-right"), J.slider.initial.percW),
                        L = "" !== f.paddingTop ? g.getStyle(f.paddingTop, J.slider.initial.percH) : g.getStyle(e.css("padding-top"), J.slider.initial.percH),
                        $ = "" !== f.paddingBottom ? g.getStyle(f.paddingBottom, J.slider.initial.percH) : g.getStyle(e.css("padding-bottom"), J.slider.initial.percH),
                        W = "" !== f.marginLeft ? g.getStyle(f.marginLeft, J.slider.initial.percW) : g.getStyle(e.css("margin-left"), J.slider.initial.percW),
                        M = "" !== f.marginRight ? g.getStyle(f.marginRight, J.slider.initial.percW) : g.getStyle(e.css("margin-right"), J.slider.initial.percW),
                        B = "" !== f.marginTop ? g.getStyle(f.marginTop, J.slider.initial.percH) : g.getStyle(e.css("margin-top"), J.slider.initial.percH),
                        _ = "" !== f.marginBottom ? g.getStyle(f.marginBottom, J.slider.initial.percH) : g.getStyle(e.css("margin-bottom"), J.slider.initial.percH);
                    h.style.margin = "0", n = "" !== f.borderLeftWidth ? g.getStyle(f.borderLeftWidth, J.slider.initial.percW) : g.getStyle(e.css("border-left-width"), J.slider.initial.percW), d = "" !== f.borderRightWidth ? g.getStyle(f.borderRightWidth, J.slider.initial.percW) : g.getStyle(e.css("border-right-width"), J.slider.initial.percW), l = "" !== f.borderTopWidth ? g.getStyle(f.borderTopWidth, J.slider.initial.percH) : g.getStyle(e.css("border-top-width"), J.slider.initial.percH), c = "" !== f.borderBottomWidth ? g.getStyle(f.borderBottomWidth, J.slider.initial.percH) : g.getStyle(e.css("border-bottom-width"), J.slider.initial.percH), 1 !== J.media.properties.$allMediaLayers.filter(e).length && !e.children("iframe").length || (p = (V = e.children()).attr("width") ? V.attr("width") : V.width(), u = V.attr("height") ? V.attr("height") : V.height(), 300 === parseInt(p) && 150 === parseInt(u) && (p = 640, u = 360), "" !== h.style.width && "auto" !== h.style.width || e.css("width", p), "" !== h.style.height && "auto" !== h.style.height || e.css("height", u), "100%" === f.width && "100%" === f.height && (f.left = "50%", f.top = "50%"), T = p / u, V.css({
                        width: "100%",
                        height: "100%"
                    }));
                    var F, A, z, D, V = m.attributes;
                    e.is("img, picture") && (D = (A = (F = e.is("img") ? e : e.find("img")).data("preloadedWidth")) / (z = F.data("preloadedHeight")), (!f.width && !f.height || "auto" === f.width && "auto" === f.height) && V && (V.width && V.height ? (t = -1 === V.width.indexOf("%") ? parseInt(V.width) : (S = parseInt(V.width), g.getStyle(V.width, J.slider.initial.percW)), i = -1 === V.height.indexOf("%") ? parseInt(V.height) : (b = parseInt(V.height), g.getStyle(V.height, J.slider.initial.percH))) : V.maxWidth && (e[0].style.width = V.maxWidth + "px", t = V.maxWidth, i = e.height()))), F = C.width ? C.width / P : (C.right - C.left) / P, P = C.height ? C.height / P : (C.bottom - C.top) / P, t || (t = f.width, -1 !== f.width.indexOf("%") && (S = parseInt(f.width)), t = (t = "" !== t && "auto" !== t ? g.getStyle(t, J.slider.initial.percW) : F - J.layers.toNum(O, k) - J.layers.toNum(I, k) - J.layers.toNum(n, k) - J.layers.toNum(d, k)) || "auto"), i || (i = f.height, -1 !== f.height.indexOf("%") && (b = parseInt(f.height)), i = (i = "" !== i && "auto" !== i ? g.getStyle(i, J.slider.initial.percH) : P - J.layers.toNum(L, k) - J.layers.toNum($, k) - J.layers.toNum(l, k) - J.layers.toNum(c, k)) || "auto"), 0 === parseInt(i) && (e.addClass("ls-force-height-auto"), parseInt(h.getBoundingClientRect().height), e.removeClass("ls-force-height-auto")), T = T || ("auto" !== t && "auto" !== i ? t / i : "auto"), !e.is("img, picture") || f.width || f.height || V && (!V || V.width || V.height) || A === t && z === i || (A !== t ? i = (t = 5 < A ? A : t) / (T = 5 < A ? D : T) : z !== i && (t = (i = 5 < z ? z : i) * (T = 5 < z ? D : T))), parseFloat(e.css("opacity")), (z = f.clipPath || f.clip || !1) && (m.clip.style.css.clipPath = z, m.clip.userDefined = !0, f.clip = "", f.clipPath = ""), D = f.webkitFilter || f.filter;
                    var R, E, N, H;
                    f.minWidth && "" !== f.minWidth && (-1 !== f.minWidth.indexOf("%") && (a = parseInt(f.minWidth)), y = -1 !== f.minWidth.indexOf("em") ? f.minWidth : parseFloat(f.minWidth)), f.minHeight && "" !== f.minHeight && (-1 !== f.minHeight.indexOf("%") && (s = parseInt(f.minHeight)), v = -1 !== f.minHeight.indexOf("em") ? f.minHeight : parseFloat(f.minHeight)), f.maxWidth && "" !== f.maxWidth && (-1 !== f.maxWidth.indexOf("%") && (r = parseInt(f.maxWidth)), x = -1 !== f.maxWidth.indexOf("em") ? f.maxWidth : parseFloat(f.maxWidth)), f.maxHeight && "" !== f.maxHeight && (-1 !== f.maxHeight.indexOf("%") && (o = parseInt(f.maxHeight)), w = -1 !== f.maxHeight.indexOf("em") ? f.maxHeight : parseFloat(f.maxHeight)), m.original = {
                        clip: z,
                        left: f.left || "0",
                        top: f.top || "0",
                        ...
                        percentWidth: S,
                        percentHeight: b,
                        percentMinWidth: a || null,
                        percentMinHeight: s || null,
                        percentMaxWidth: r || null,
                        percentMaxHeight: o || null,
                        backgroundImage: f.backgroundImage,
                        backgroundSize: f.backgroundSize || "cover",
                        backgroundRepeat: f.backgroundRepeat,
                        backgroundPosition: f.backgroundPosition,
                        ratio: T,
                        paddingLeft: O,
                        paddingTop: L,
                        paddingRight: I,
                        ...
                        borderRightWidth: d,
                        borderBottomWidth: c,
                        borderRadius: (R = e, N = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], H = "", (E = f).borderRadius && (-1 === E.borderRadius.indexOf("/") ? ie.each(["border-top-left-radius", "border-top-right-radius", "border-bottom-right-radius", "border-bottom-left-radius"], function(e, t) {
                            e = E[N[e]], t = R.css(t), t = ie.trim(void 0 !== e && e.length ? e : t); - 1 == t.indexOf(" ") && -1 == t.indexOf("em") && -1 == t.indexOf("%") && (t = parseInt(t)), H += t + " "
                        }) : H = E.borderRadius), ie.trim(H)),
                        fontSize: k,
                        lineHeight: h.style.lineHeight,
                        letterSpacing: h.style.letterSpacing,
                        textStrokeWidth: h.style.textStrokeWidth || h.style.webkitTextStrokeWidth,
                        color: e.css("color"),
                        boxShadow: h.style.boxShadow,
                        textShadow: h.style.textShadow,
                        zIndex: parseInt(e.css("z-index")) || "auto",
                        filter: D,
                        backgroundColor: e.css("background-color"),
                        dataLS: e.attr("data-ls") || "",
                        styles: e.attr("style") || ""
                    }, f.width && "auto" !== f.width || (m.original.autoWidth = !0), f.height && "auto" !== f.height || (m.original.autoHeight = !0), f.zIndex = "auto", m.responsive = {
                        left: f.left ? parseInt(f.left) : 0,
                        top: f.top ? parseInt(f.top) : 0,
                        width: t,
                        height: i
                    }, e.is("picture") && e.css({
                ...
                parseScaleProperties: function(e) {
                    for (var t = [{
                        ...
                        var a = t[i];
                        e[a.x] && e[a.y] && e[a.x] === e[a.y] && (e[a.s] = e[a.x], delete e[a.x], delete e[a.y])
                    }
                    return e
                },
                properties: function(e, t, i) {
                    t = t || e.data("slideIndex");
                    var a = e.data(J.defaults.init.dataKey);
                    e.data("ls");
                    if (a.is.textLayer = !(e.is("img, picture") || a.is.mediaLayer || a.is.backgroundVideo), (a.self = e).data("ls")) {
                        for (var s, r, o, n, l = J.defaults.layer.keys, d = e.data("ls").split(";"), c = {}, p = 0; p < d.length; p++) ie.trim(d[p]) && (s = d[p].indexOf(":"), r = d[p].substring(0, s).trim(), o = d[p].substring(s + 1).trim(), r && (c[r] = o));
                        for (n in d = null, c = this.parseScaleProperties(c)) {
                            ...
                            if (r = n.toLowerCase(), o = c[n], -1 == ["thumbnail", "poster"].indexOf(r) && (o = o.toLowerCase()), (r = r.replace("split", "text")).match(/(text)/) && (y = !0), void 0 !== l[r]) {
                                if (u = l[r][0], f = o, "overlay" !== r && (f = J.functions.convert.properties(o)), -1 !== r.indexOf("mirror") && (f = J.layers.set.mirrorTransitions(o)), !o || -1 === o.indexOf("random") && o.charAt(0) !== J.defaults.init.openingBracket || (g = !0), g && (y || -1 !== r.indexOf("offset") || (f = J.functions.convert.randomProperties(f, u, e, a)), a.should.update || (a.should.update = !0)), "number" == typeof f && u.match(/(duration|startat|shift|delay)/i) && (f /= 1e3), r.match(/(fade)(.+)/)) switch (f) {
                                    case !0:
                                        f = 0;
                                        break;
                                    case !1:
                                ...
                                void 0 !== (m = l[r][1]) ? "" !== f ? "object" == typeof f && -1 == r.indexOf("mirror") ? r.match(/(text)/) ? m.match(/(converted)/i) ? a[m][u] = f : a[m].cycle[u] = f : (h = J.functions.convert.properties(ie.trim(f[0])), J.debugMode && J.debug.add("warn", "layerInit.prop1", [r, f, h]), "number" == typeof h && u.match(/(duration|startat|shift|delay)/i) && (h /= 1e3), a[m][u] = h) : y && g ? a[m].random[u] = f : a[m][u] = f : J.debugMode && J.debug.add("warn", "layerInit.prop2", r) : a[u][r] = f
                            } else "clip" === r ? (a.original.clip = o, a.clip.style.css.clipPath = o) : J.debugMode && J.debug.add("warn", "layerInit.prop4", r)
                        }
                    }
                    if (J.browser.isOld && (a.in.enabled = !0, a.textIn.enabled = !1, a.textOut.enabled = !1, a.textIn.type = null, a.textOut.type = null), a.in.enabled && (a.inLayerTo.ease = a.inLayerStyleTo.ease = a.inClipTo.ease = J.functions.convert.easing(a.in.ease)), void 0 !== a.inLayerStyleShouldBeConvertedFrom.borderRadius && (a.inLayerStyleShouldBeConvertedTo.borderRadius = a.original.borderRadius), void 0 !== a.outLayerStyleShouldBeConvertedTo.borderRadius && (a.outLayerStyleShouldBeConvertedFrom.borderRadius = a.original.borderRadius), a.inLayerStyleFromCSS.backgroundColor && (a.inLayerStyleToCSS.backgroundColor = a.original.backgroundColor), a.outLayerStyleToCSS.backgroundColor && (a.outLayerStyleFromCSS.backgroundColor = a.original.backgroundColor), a.inLayerStyleFromCSS.color && (a.inLayerStyleToCSS.color = a.original.color), a.outLayerStyleToCSS.color && (a.outLayerStyleFromCSS.color = a.original.color), void 0 !== a.inLayerStyleShouldBeConvertedFrom.width && (a.inLayerStyleShouldBeConvertedTo.width = a.original.width), void 0 !== a.outLayerStyleShouldBeConvertedTo.width && (a.outLayerStyleShouldBeConvertedFrom.width = a.original.width), void 0 !== a.inLayerStyleShouldBeConvertedFrom.height && (a.inLayerStyleShouldBeConvertedTo.height = a.original.height), void 0 !== a.outLayerStyleShouldBeConvertedTo.height && (a.outLayerStyleShouldBeConvertedFrom.height = a.original.height), void 0 !== a.out.showUntil && 0 !== a.out.showUntil && (a.out.startAt = "transitioninend + " + a.out.showUntil), -1 !== a.out.startAt.indexOf("slidechangeonly") && "slidechangeonly" !== a.out.startAt && (a.out.startAt = "slidechangeonly"), a.out.enabled && (a.outLayerTo.ease = a.outLayerStyleTo.ease = a.outClipTo.ease = J.functions.convert.easing(a.out.ease)), ie.isNumeric(a.loop.count) && (0 < a.loop.count || -1 === a.loop.count) && !1 !== a.loop.enabled ? (a.loop.enabled = !0, a.loopTo.ease = a.loopClipTo.ease = J.functions.convert.easing(a.loop.ease), -1 !== a.loop.count ? a.loop.yoyo ? a.loop.repeat = 2 * a.loop.count - 1 : a.loop.repeat = a.loop.count - 1 : a.loop.repeat = -1) : a.loop.enabled = !1, (!ie.isEmptyObject(a.hoverToCSS) || a.hoverShouldBeConverted.x || a.hoverShouldBeConverted.y || a.hoverShouldBeConverted.borderRadius || a.hoverShouldBeConverted.filter) && !1 !== a.hover.enabled ? (a.hover.enabled = !0, a.hover.easeOut || (a.hover.easeOut = a.hover.easeIn), a.hover.easeIn = J.functions.convert.easing(a.hover.easeIn), a.hover.easeOut = J.functions.convert.easing(a.hover.easeOut, !0), a.hover.durationOut || (a.hover.durationOut = a.hover.durationIn), ee.TweenMax.set(e[0], {
                            autoCSS: !1,
                            css: {
                                transformPerspective: a.hoverShouldBeConverted.transformPerspective
                            }
                        })) : a.hover.enabled = !1, a.parallax.level && ie.isNumeric(a.parallax.level) && 0 !== a.parallax.level && !1 !== a.parallax.enabled ? (a.parallax.enabled = !0, a.parallax.reset && e.attr("data-ls-parallax-reset", "")) : a.parallax.enabled = !1, a.is.slideBackground) {
                        var v = {
                            scale: 1,
                            rotation: 0
                        };
                        if (J.slides[t].kenBurns.zoom && (a.kenBurns = J.slides[t].kenBurns), a.kenBurns.zoom) {
                            switch (a.kenBurns.from = {}, a.kenBurns.to = {}, a.kenBurns.zoom) {
                                case "out":
                                    a.kenBurns.from.scale = a.kenBurns.scale || 1, a.kenBurns.from.rotation = a.kenBurns.rotation || 0, a.kenBurns.to = v;
                                    break;
                                case "in":
                                    a.kenBurns.from = v, a.kenBurns.to.scale = a.kenBurns.scale || 1, a.kenBurns.to.rotation = a.kenBurns.rotation || 0
                            }
                            delete a.kenBurns.scale, delete a.kenBurns.rotation
                        } else a.kenBurns.from = v, a.kenBurns.to = v;
                        ie.isEmptyObject(J.slides[t].filter) || (J.slides[t].filter.from && (a.filter.values.bgFrom = J.transitions.layers.filters.convert(J.slides[t].filter.from)), J.slides[t].filter.to && (a.filter.values.bgTo = J.transitions.layers.filters.convert(J.slides[t].filter.to)))
                    }
                    if (a.textIn.type && -1 === J.defaults.layer.splitTypeKeys.indexOf(a.textIn.type) && (J.debugMode && J.debug.add("warn", "layerInit.splitType3a", [e[0].tagName, a.textIn.type]), delete a.textIn.type, delete a.textIn.ns, a.textIn.enabled = !1), a.textOut.type && -1 === J.defaults.layer.splitTypeKeys.indexOf(a.textOut.type) && (J.debugMode && J.debug.add("warn", "layerInit.splitType3b", [e[0].tagName, a.textOut.type]), delete a.textOut.type, delete a.textOut.ns, a.textOut.enabled = !1), a.textIn.type || a.textOut.type) {
                        var x = 0;
                        if (a.is.textLayer ? (a.textIn.type && (a.textIn.enabled = !0, a.textInNodesTo.ease = J.functions.convert.easing(a.textInNodesTo.ease), a.textIn.split = a.textIn.type.split("_")[0], e.children().length && J.debugMode && (x = 1)), a.textOut.type && !J.o.inLayerPreview && (a.textOut.enabled = !0), a.textOut.enabled && (a.textOutNodesTo.ease = J.functions.convert.easing(a.textOutNodesTo.ease)), a.textOut.enabled && a.textOut.type.split("_")[0] !== a.textIn.split && (a.textIn.split += ", " + a.textOut.type.split("_")[0], e.children().length && J.debugMode && (x = 1)), -1 !== a.textIn.split.indexOf("chars") && -1 === a.textIn.split.indexOf("words") && (a.textIn.split += ", words"), -1 !== a.textIn.split.indexOf("words") && -1 === a.textIn.split.indexOf("lines") && (a.textIn.split += ", lines")) : (delete a.textIn.type, delete a.textOut.type, delete a.textIn.ns, delete a.textOut.ns, J.debugMode && (x = 2)), J.debugMode && 0 !== x && t && !i) switch (x) {
                            case 1:
            ...
            wrap: function(u, e) {
                ...
                J.slides[u].wrapped || "wrapping" === J.slides[u].wrapped || (J.slides[u].wrapped = "wrapping", t = e ? 25 : 0, e = J.slides[u].$layers, 0 === (h = e.length) ? J.slides[u].wrapped = !0 : e.each(function(c, p) {
                    J.timeouts["slide-" + u + "-layer-" + c] = setTimeout(function() {
                        ...
                        } : (a = a || c + 101, d.zIndex = a, l.original.customZIndex = a), J.browser.isSafari && (d.transform = "translateZ(0)"), J.layers.set.wrappers(e, l, u), l.elements.$outerWrapper.css(d).addClass(s), l.styleSettings.pointerevents && l.elements.$innerWrapper.css("pointer-events", "none"), l.is.slideBackground && l.elements.$bgWrapper.css({
            ...
            set: {
                pauseOnHover: function() {
                    J.o.pauseOnHover = !0 === J.o.pauseOnHover ? "slideshowOnly" : J.o.pauseOnHover, !1 !== J.o.pauseOnHover && $.on("mouseenter." + W, function() {
                ...
                normalizedSequence: function() {
                    var e = J.o.shuffleSlideshow ? "randomized" : "normal",
                        ...
                        a = t.indexOf(J.slides.first.index);
                    J.slideshow.sequence.normalized = [];
                    for (var s = a; s < i; s++) J.slideshow.sequence.normalized.push(t[s]);
                    for (var r = 0; r < a; r++) J.slideshow.sequence.normalized.push(t[r])
                },
                prevNext: function(e) {
            ...
            changeTo: function(e, t, i) {
                ...
                if (J.slideshow.forceSlideChangeTo = null, !this.firstStart && J.api.hasEvent("slideChangeWillStart")) {
                    var a = J.api.triggerEvent("slideChangeWillStart", J.api.eventData());
                    if (!1 === a) return;
                    ie.isNumeric(a) && (e = parseInt(a))
                }
            ...
            isPlayable: function(e, t) {
                return !(e.is("[data-ls-animating-out], [data-ls-hidden]") && !t.is.backgroundVideo)
            },
            get: function(e) {
            ...
            set: {
                ...
                mediaElements: function(e, t, i) {
                    var a = ie("<div>").addClass("ls-vpcontainer").appendTo(e);
                    !("autoplay" in i.mediaSettings) && J.o.autoPlayVideos || i.mediaSettings.autoplay ? "instant" === i.mediaSettings.autoplay ? e.addClass("ls-instant-autoplay") : e.addClass("ls-autoplay") : ie("<div>").appendTo(a).addClass("ls-playvideo"), t.is("iframe") && i.mediaProperties.poster && ie("<div>").appendTo(a).addClass("ls-videopreview").attr({
                        style: "background-image: url(" + i.mediaProperties.poster + ")"
                    }), t.is("video, audio") && i.mediaProperties.poster && ie("<div>").appendTo(a).addClass("ls-videopreview").attr({
                        style: "background-image: url(" + i.mediaProperties.poster + ")"
                    })
                },
                properties: function(e, t, i) {
            ...
            events: {
                start: function(e, t, i) {
                    var a;
                    J.api.hasEvent("mediaDidStart") && !i.mediaProperties.alreadyStarted && J.media.functions.allowedToPlay(e, i) && ((a = J.api.eventData()).event.target = e[0], J.api.triggerEvent("mediaDidStart", a), i.mediaProperties.alreadyStarted = !0)
                },
                stop: function(e, t, i) {
                    var a;
                    J.api.hasEvent("mediaDidStop") && i.mediaProperties.alreadyStarted && ((a = J.api.eventData()).event.target = e[0], J.api.triggerEvent("mediaDidStop", a), i.mediaProperties.alreadyStarted = !1)
                }
            },
            unmute: {
                set: function(e, t, i) {
                ...
                singleMediaElement: function(e) {
                    ...
                    switch (i.mediaProperties.type) {
                        case "youtube":
                            J.media.properties.allowToUnmute && (a = !0, i.mediaProperties.player.unMute());
                            break;
                        case "vimeo":
                            J.media.properties.allowToUnmute && (a = !0, t = i.mediaSettings.volume ? i.mediaSettings.volume / 100 : 1, i.mediaProperties.player.setVolume(t));
                            break;
                        case "html5":
                            a = !0, e[0].muted = !1
                    }
            ...
            functions: {
                ...
                urlToObject: function(e) {
                    ...
                    return e && e.split("#")[0].replace(/([^=&]+)=([^&]*)/g, function(e, t, i) {
                        a[decodeURIComponent(t)] = ie.isNumeric(decodeURIComponent(i)) ? parseInt(decodeURIComponent(i)) : decodeURIComponent(i)
                    }), a
                },
            ...
            youtube: {
                ...
                init: function() {
                    ...
                    this.$medias = J.slider.$hiddenWrapper.find('iframe[src*="youtube-nocookie.com"], iframe[src*="youtube.com"], iframe[src*="youtu.be"], iframe[data-src*="youtube-nocookie.com"], iframe[data-src*="youtube.com"], iframe[data-src*="youtu.be"]').each(function() {
                        ...
                        var i, a, s, r, o, n, l, d, c = t.data(J.defaults.init.dataKey),
                        ...
                        c.mediaProperties = {
                            ...
                            embedID: m,
                            embedOptions: u
                        }, h ? (c.mediaProperties.poster = h, J.media.set.properties(t, e, c)) : (i = ["default.jpg", "mqdefault.jpg", "hqdefault.jpg", "sddefault.jpg", "maxresdefault.jpg"], a = "https://img.youtube.com/vi/" + p.split("embed/")[1].split("?")[0] + "/", s = a + J.o.youtubePreview, o = r = 0, n = function() {
                            this.width > r && (r = this.width, s = this.src), d()
                        }, l = function() {
                            d()
                        }, d = function() {
                            (o += 1) === i.length && (c.mediaProperties.poster = s, J.media.set.properties(t, e, c))
                ...
                createPlayer: function(t, i, a, s, r) {
                    a.mediaProperties.playerState = "initializing", "controls" in a.mediaSettings && (a.mediaProperties.options.controls = a.mediaSettings.controls ? 1 : 0), "loop" in a.mediaSettings && (a.mediaProperties.options.loop = a.mediaSettings.loop ? 1 : 0), "showinfo" in a.mediaSettings && (a.mediaProperties.options.showinfo = a.mediaSettings.showinfo ? 1 : 0), a.mediaProperties.options.loop ? a.mediaProperties.options.playlist = a.mediaProperties.embedID : delete a.mediaProperties.options.playlist, 0 === a.mediaProperties.options.showinfo && (a.mediaProperties.options.modestbranding = 1), i.attr("src", "https://" + s + "?" + jQuery.param(a.mediaProperties.options)).on("load", function() {
                        a.mediaProperties.player = new YT.Player(i[0], {
                            events: {
                                onReady: function(e) {
                                    a.mediaProperties.playerState = "ready", a.mediaSettings.volume && a.mediaProperties.player.setVolume(a.mediaSettings.volume), r && !a.mediaProperties.shouldPlay || (J.media.youtube.play(t, i, a, s), a.mediaProperties.shouldPlay = !1)
                                },
                                onStateChange: function(e) {
                                    switch (e.data) {
                                        case 0:
                                            a.mediaProperties.options.loop && 1 === a.mediaProperties.options.loop || J.media.functions.mediaEnded(i, t, a);
                                            break;
                                        case 1:
                                            J.media.events.start(i, t, a), a.mediaProperties.lastStarted = Date.now();
                                            break;
                                        case 2:
                                        case -1:
                                    ...
                                    1 === e.data ? J.media.set.dataAttribute(i, "playing") : J.media.set.dataAttribute(i, "not-playing"), J.media.youtube.savePlayerState(a, e.data)
                                }
                            }
                        })
                    })
                ...
                play: function(e, t, i, a, s) {
                    void 0 !== t.attr("data-ls-muted-by-browser") && J.media.unmute.singleMediaElement(t), i.mediaProperties.player ? i.mediaProperties.player.playVideo ? (!i.is.backgroundVideo || "muted" in i.mediaSettings || i.mediaProperties.player.mute(), i.mediaSettings.muted ? J.o.rememberUnmuteState && J.media.properties.userDidUnmute || (i.mediaProperties.player.mute(), "offertounmute" == i.mediaSettings.muted && J.media.unmute.set(t, i.mediaProperties.type)) : s && (i.mediaProperties.player.mute(), J.media.unmute.set(t, i.mediaProperties.type, !0)), J.media.functions.allowedToPlay(t, i) ? J.media.isPlayable(e, i) && i.mediaProperties.player.playVideo() : J.media.youtube.stop(e, t, i, !0)) : i.mediaProperties.shouldPlay = !0 : i.mediaProperties.playerState ? i.mediaProperties.shouldPlay = !0 : this.createPlayer(e, t, i, a)
                },
                stop: function(e, t, i, a) {
                    i.mediaProperties.player && (i.mediaProperties.player.pauseVideo && i.mediaProperties.player.pauseVideo(), a && i.mediaProperties.player.seekTo && (i.mediaProperties.player.seekTo(0), i.mediaProperties.player.pauseVideo()), i.is.backgroundVideo || J.media.set.thumbnail(e.find(".ls-vpcontainer"), "show"), J.media.events.stop(t, e, i))
                }
            },
            vimeo: {
                defaults: {
                ...
                init: function() {
                    ...
                    t.length && (J.timeouts.loadVimeo = Math.floor(Date.now() / 1e3), J.media.properties.$allMediaLayers = J.media.properties.$allMediaLayers.add(t.closest(".ls-layer")), d = 0, ie("<script>").attr({
                        ...
                        J.media.vimeo.$medias.each(function() {
                            ...
                            var a = i.data(J.defaults.init.dataKey),
                                e = t.attr("src") || t.attr("data-src"),
                                s = J.media.functions.urlToObject(e),
                                r = e.split("video/")[1].split("?")[0],
                                o = "https://vimeo.com/api/oembed.json?url=" + encodeURIComponent("https://vimeo.com/video/" + r + (s.h ? "?h=" + s.h : "")),
                                e = e.split("?")[0].split("//")[1];
                            J.media.vimeo.defaults.player_id = "ls-vimeo-" + d;
                            r = J.media.set.customPoster(i, a);
                            a.mediaProperties = {
                                type: "vimeo",
                                $media: t,
                                embedURL: e,
                            ...
                            function n(e) {
                                a.mediaProperties.poster = e, (0 === c || 0 < c && ++l == c) && (window._layerSlider.globals.vimeoIsReady = !0), J.media.set.properties(i, t, a)
                            }
                            r ? n(r) : ie.getJSON(o, function(e) {
                                n(e.thumbnail_url)
                            }), i.on("playMedia." + W + " click." + W, ".ls-vpcontainer", function() {
                                J.media.set.thumbnail(ie(this), "hide"), J.media.functions.checkSlideshowState(i, a), J.media.vimeo.play(i, t, a, e)
                            }).on("playBackgroundVideo." + W, function() {
                                J.media.vimeo.play(i, t, a, e), J.layers.set.dataAttribute("add", i, "active")
                            }).on("stopBackgroundVideo." + W, function() {
                                J.media.vimeo.stop(i, t, a, !0), J.layers.set.dataAttribute("add", i, "hidden")
                            }).on("preloadBackgroundVideo." + W, function() {
                                J.media.vimeo.createPlayer(i, t, a, e, !0)
                            })
                        }), J.functions.setStates(J.slider, {
                            waitingForVimeo: !1
                        })
                ...
                createPlayer: function(e, t, i, a, s) {
                    ...
                    "controls" in i.mediaSettings && (i.mediaProperties.options.controls = i.mediaSettings.controls ? 1 : 0, delete i.mediaSettings.controls), "loop" in i.mediaSettings && (i.mediaProperties.options.loop = i.mediaSettings.loop ? 1 : 0), "showinfo" in i.mediaSettings && (i.mediaSettings.showinfo ? (i.mediaProperties.options.byline = 1, i.mediaProperties.options.portrait = 1, i.mediaProperties.options.title = 1) : (i.mediaProperties.options.byline = 0, i.mediaProperties.options.portrait = 0, i.mediaProperties.options.title = 0), delete i.mediaProperties.options.showinfo), "volume" in i.mediaSettings && (0 === i.mediaSettings.volume ? (i.mediaSettings.volume = 100, i.mediaSettings.muted = !0) : (i.mediaSettings.volume < 0 || 100 < i.mediaSettings.volume) && (i.mediaSettings.volume = 100)), i.mediaSettings.muted && (i.mediaProperties.options.muted = 1), t.attr("src", "https://" + a + "?" + jQuery.param(i.mediaProperties.options)), i.mediaProperties.player = new Vimeo.Player(t[0]), i.mediaProperties.player.on("play", function() {
                        ...
                        i.mediaProperties.playerState = "ready", i.mediaSettings.volume && !i.mediaSettings.muted && ie.isNumeric(i.mediaSettings.volume) && 0 <= i.mediaSettings.volume && i.mediaSettings.volume <= 100 && i.mediaProperties.player.setVolume(i.mediaSettings.volume / 100), s || J.media.vimeo.play(e, t, i, a)
                    })
                },
                play: function(t, i, a, s, e) {
                    void 0 !== i.attr("data-ls-muted-by-browser") && J.media.unmute.singleMediaElement(i), a.mediaProperties.player ? (!a.is.backgroundVideo || "muted" in a.mediaSettings || a.mediaProperties.player.setVolume(0), a.mediaSettings.muted && (J.o.rememberUnmuteState && J.media.properties.userDidUnmute ? J.o.rememberUnmuteState && J.media.properties.userDidUnmute && (a.mediaProperties.player.setVolume(a.mediaSettings.volume / 100 || 1), delete a.mediaSettings.muted) : (a.mediaProperties.player.setVolume(0), "offertounmute" == a.mediaSettings.muted && J.media.unmute.set(i, a.mediaProperties.type))), e ? (a.mediaProperties.player.setVolume(0), J.media.unmute.set(i, a.mediaProperties.type, !0)) : a.mediaProperties.player.getVolume().then(function(e) {
                        0 == e && "offertounmute" == a.mediaSettings.muted && J.media.unmute.set(i, a.mediaProperties.type)
                    }), J.media.functions.allowedToPlay(i, a) ? a.mediaProperties.player.play().then(function() {}).catch(function(e) {
                        switch (e.name) {
                            case "PasswordError":
                            ...
                            case "PrivacyError":
                                ...
                                break;
                            default:
                                J.media.vimeo.play(t, i, a, s, !0)
                        }
                    }) : J.media.vimeo.stop(t, i, a, !0)) : this.createPlayer(t, i, a, s)
                },
                stop: function(e, t, i, a) {
                    i.mediaProperties.player && (i.mediaProperties.player.pause(), a && i.mediaProperties.player.setCurrentTime(0), i.is.backgroundVideo || J.media.set.thumbnail(e.find(".ls-vpcontainer"), "show"), J.media.events.stop(t, e, i))
                }
            },
            html5: {
                singleInit: function(t) {
                    ...
                    o.mediaProperties = {
                        ...
                        void 0 !== (e = ie(this).attr("type")) && !1 !== e || (i = ie(this).attr("src"), a = i.split("."), s = a[a.length - 1].toLowerCase(), ie(this).attr("type", ie(this).parent()[0].tagName.toLowerCase() + "/" + s)), "" !== t[0].canPlayType(ie(this).attr("type")) && (o.mediaProperties.canBePlayed = !0)
                    }) : void 0 !== t.attr("src") && !1 !== t.attr("src") && (i = t.attr("src"), a = i.split("."), s = a[a.length - 1].toLowerCase(), "" !== t[0].canPlayType(t[0].tagName.toLowerCase() + "/" + s) && (o.mediaProperties.canBePlayed = !0)), o.mediaProperties.canBePlayed && (J.media.set.properties(r, t, o), t.on("ended." + W, function() {
                        ...
                        J.media.set.dataAttribute(t, "not-playing")
                    }), r.on("playMedia." + W + " click." + W, ".ls-vpcontainer", function(e) {
                ...
                play: function(e, t, i) {
                    var a;
                    i.mediaProperties.canBePlayed && (void 0 !== t.attr("data-ls-muted-by-browser") && J.media.unmute.singleMediaElement(t), i.mediaSettings.muted && (J.o.rememberUnmuteState && J.media.properties.userDidUnmute ? J.o.rememberUnmuteState && J.media.properties.userDidUnmute && (t[0].muted = !1) : (t[0].muted = !0, "offertounmute" == i.mediaSettings.muted && J.media.unmute.set(t, i.mediaProperties.type))), void 0 !== (a = t[0].play()) && a.then(function(e) {}).catch(function(e) {
                ...
                stop: function(e, t, i, a) {
                    i.mediaProperties.canBePlayed && (t[0].pause(), a && (t[0].currentTime = 0), i.is.backgroundVideo || J.media.set.thumbnail(ie(this), "show"), J.media.events.stop(t, e, i))
                }
            }
        }, J.yourLogo = {
            init: function() {
            ...
            resize: function() {
                ...
                var e = "auto",
                    ...
                    a = this.$element.data("originalBottom") && -1 != this.$element.data("originalBottom").indexOf("%") ? $.height() / 100 * parseFloat(this.$element.data("originalBottom")) - this.$element.height() / 2 + parseInt($.css("padding-bottom")) : parseInt(this.$element.data("originalBottom")) * J.resize.ratio;
                this.$element.css({
                    left: e,
                    right: t,
                    top: i,
            ...
            navigation: {
                ...
                prevNext: {
                    init: function() {
                        ie('<a class="ls-gui-element ls-nav-prev" aria-label="jump to the previous slide" href="#" />').on("click." + W, function(e) {
                            e.preventDefault(), $.layerSlider("prev")
                        }).appendTo($), ie('<a class="ls-gui-element ls-nav-next" aria-label="jump to the next slide" href="#" />').on("click." + W, function(e) {
                ...
                bottom: {
                    ...
                    bullets: {
                        init: function() {
                            ...
                            for (var e = 0; e < J.slides.count; e++) {
                                var i = ie('<a href="#" aria-label="jump to slide ' + (e + 1) + '" />').appendTo($.find(".ls-bottom-slidebuttons")).data("index", e + 1).on("click." + W, function(e) {
                                    e.preventDefault(), $.layerSlider(ie(this).data("index"))
                                });
                                "hover" == J.o.thumbnailNavigation && i.on("mouseenter." + W, function() {
                                    var e = ie(this);
                    ...
                    createStartStop: function() {
                        this.buttonStart = ie('<a class="ls-nav-start" aria-label="start slideshow" href="#" />').on("click." + W, function(e) {
                            e.preventDefault(), $.layerSlider("start")
                        }).prependTo($.find(".ls-bottom-nav-wrapper")), this.buttonStop = ie('<a class="ls-nav-stop" aria-label="stop slideshow" href="#" />').on("click." + W, function(e) {
                        ...
                        init: function() {
                            ...
                            for (var e = 0; e < J.slides.count; e++) {
                                var t = e + 1,
                                    ...
                                    a = "";
                                "contain" !== J.o.tnFillMode && (i = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", a = 'style="background-image: url(' + J.slides[t].data.thumbnail + "); background-size: " + J.o.tnFillMode + ';"');
                                i = ie('<a href="#" class="ls-thumb-' + (e + 1) + '"  aria-label="jump to slide ' + (e + 1) + '"><img ' + a + ' src="' + i + '"></a>');
                                J.slides[t].data.tnAlt && i.find("img").attr("alt", J.slides[t].data.tnAlt), i.data("index", t).on("click." + W, function(e) {
                                    e.preventDefault(), $.layerSlider(ie(this).data("index"))
                                }).appendTo($.find(".ls-thumbnail-slide")), "ontouchstart" in window || i.on("mouseenter." + W, function() {
                            ...
                            J.gui.navigation.bottom.buttonStart && J.gui.navigation.bottom.buttonStop && (J.gui.navigation.bottom.wrapper = ie('<div class="ls-bottom-nav-wrapper ls-below-thumbnails"></div>').appendTo($), J.gui.navigation.bottom.buttonStart.clone().on("click." + W, function(e) {
                                e.preventDefault(), $.layerSlider("start")
                            }).appendTo(J.gui.navigation.bottom.wrapper), J.gui.navigation.bottom.buttonStop.clone().on("click." + W, function(e) {
                                e.preventDefault(), $.layerSlider("stop")
                            }).appendTo(J.gui.navigation.bottom.wrapper)), J.o.hoverBottomNav && this.setHover()
                        },
                        setHover: function() {
                            var e = this;
                            e.wrapper.css("display", "none"), J.gui.navigation.bottom.wrapper && (J.gui.navigation.bottom.wrapper = "block" == J.gui.navigation.bottom.wrapper.css("display") ? J.gui.navigation.bottom.wrapper : $.find(".ls-above-thumbnails"), J.gui.navigation.bottom.wrapper.css("display", "none")), $.on("mouseenter." + W, function() {
            ...
            media: {
                init: function() {
                    0 < J.media.properties.$allMediaLayers.length && ie('<div class="ls-gui-element ls-media-unmute" aria-label="Unmute"><div class="ls-media-unmute-bg"></div><div class="ls-icon-muted"></div><div class="ls-icon-unmuted"></div></div>').on("click." + W, function(e) {
            ...
            skin: {
                load: function() {
                    ...
                    }, 150))) : e = document.createStyleSheet ? (document.createStyleSheet(t), ie('link[href="' + t + '"]')) : ie('<link rel="stylesheet" href="' + t + '" type="text/css" />').appendTo(i), e.on("load." + W, function() {
            ...
            timers: {
                init: function() {
                    ...
                    var e = !1;
                    (e = J.o.showSlideBarTimer ? ie("<div>").insertAfter($) : ie('[data-slidebar-for="' + $.attr("id") + '"], [data-slidebar-for="' + W + '"]')).length && (e.addClass("ls-gui-element"), this.slidebar.create(e))
                },
                bar: {
                    create: function() {
                ...
                slidebar: {
                    ...
                    create: function(e) {
                        function i(e, t) {
                            (s = (e.pageX || J.device.touchX || 0) - o.$element[t].offset().left - o.sliderContainerElementWidth[t] / 2) < 0 && (s = 0), s > o.containerElementWidth[t] - o.sliderContainerElementWidth[t] && (s = "calc( 100% - " + J.gui.timers.slidebar.sliderContainerElementWidth[t] + "px )"), o.$sliderContainerElement[t].css({
                                left: s
                            }), J.transitions._slideTimeline && J.transitions._slideTimeline.progress("string" == typeof s ? J.transitions.layers.timeline.progress : s / (o.containerElementWidth[t] - o.sliderContainerElementWidth[t]) * J.transitions.layers.timeline.progress)
                        }
                        ...
                        function a(e) {
                            "dragging" == J.gui.timers.slidebar.state && (J.transitions._slideTimeline && J.transitions.layers.timeline.state.finished && J.transitions._slideTimeline.progress() !== J.transitions.layers.timeline.progress && J.functions.setStates(J.transitions.layers.timeline, {
                                finished: !1
                            }), ie(document).off("mousemove." + W), ie("body").prop("unselectable", !1).removeClass("ls-unselectable"), J.o.pauseLayers && !J.slideshow.state.running || J.slider.state.isPaused || !J.transitions._slideTimeline || J.o.playByScroll || (!0 === J.transitions.layers.timeline.state.started ? J.transitions.layers.timeline.resume() : J.transitions.layers.timeline.play()), J.gui.timers.slidebar.state = !1)
                        }
                        var s, r = ie(document),
                            o = this;
                        ie.each(e, function(t, e) {
                            o.$containerElement[t] = ie(e).addClass("ls-slidebar-container " + W), o.$element[t] = ie("<div>").addClass("ls-slidebar").appendTo(o.$containerElement[t]), o.$progressBarElement[t] = ie("<div>").addClass("ls-progressbar").appendTo(o.$element[t]), o.$sliderContainerElement[t] = ie("<div>").addClass("ls-slidebar-slider-container").appendTo(o.$containerElement[t]), o.$sliderElement[t] = ie("<div>").addClass("ls-slidebar-slider").appendTo(o.$sliderContainerElement[t]), o.sliderContainerElementWidth[t] = o.$sliderContainerElement[t].width(), o.$sliderContainerElement[t].css({
                                marginTop: -o.$sliderElement[t].outerHeight() / 2
                            }), o.$containerElement[t].on("touchmove." + W, function(e) {
                                i(e, t)
                            }), o.$containerElement[t].on("touchend." + W, function(e) {
                                a()
                            }), o.$containerElement[t].on("mousedown." + W + " touchstart." + W, function(e) {
                                J.transitions.layers.timeline.pause(0), ie("body").prop("unselectable", !0).addClass("ls-unselectable"), ie(document).on("mousemove." + W, function(e) {
                                    i(e, t)
                                }), i(e, t), J.gui.timers.slidebar.state = "dragging"
                            }), r = r.add(o.$sliderElement[t])
                        }), ie("body").on("mouseup." + W, function(e) {
                            a()
                        })
                    }
                }
            ...
            set: {
                keyboard: function() {
                    J.o.keybNav && ie("body").on("keydown." + W, function(e) {
            ...
            init: function() {
                J.slider.$hiddenWrapper.find(".ls-slide img").each(function() {
                    var e, t = ie(this),
                        i = t[0],
                        a = {};
                    t.is(".ls-layer, .ls-bg") && (i.getAttribute("width") && (a.width = i.getAttribute("width")), i.getAttribute("height") && (a.height = i.getAttribute("height")), i.sizes && (a.sizes = i.sizes), J.o.useSrcset && (t.data("srcset") || i.srcset) && (a.srcSet = t.data("srcset") || i.srcset, a.curSrc = i.currentSrc, e = a.srcSet.split(",").map(function(e) {
                        return parseInt(ie.trim(e).split(" ")[1])
                    }), a.maxWidth = Math.max.apply(null, e)), t.removeAttr("width height sizes srcset loading"), ie.isEmptyObject(a) || (t.data(J.defaults.init.dataKey).attributes = a)), t.data("lazy-src") ? t.data("src", t.data("lazy-src")) : t.attr("data-tgpli-src") ? t.data("src", t.attr("data-tgpli-src")) : t.attr("data-lazy-src") ? t.data("src", t.attr("data-lazy-src")) : t.attr("data-lazy") ? t.data("src", t.attr("data-lazy")) : t.data("src") ? a.curSrc && t.data("src", a.curSrc) : t.data("src", a.curSrc || i.src), t.attr("data-lazyset") ? t.attr("srcset", t.attr("data-lazyset")) : t.attr("data-lazy-srcset") ? t.attr("srcset", t.attr("data-lazy-srcset")) : t.attr("data-tgpli-srcset") && t.attr("srcset", t.attr("data-tgpli-srcset")), t.removeAttr("lazy lazyload data-lazy-src data-tgpli-src data-lazy data-lazyset data-lazy-srcset data-tgpli-srcset"), t.attr("src", "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7")
                })
            },
            imagesOfSlide: function(e, t) {
                ...
                !0 !== J.slides[e].wrapped ? (this.slideIndex = e, t ? (this.onCompleteCallback = t, J.functions.setStates(J.slider, {
                    ...
                    a = ie(this), s = this;
                    var e, t = a.data(J.defaults.init.dataKey);
                    a.is("img") ? (a.data("src") && a.attr("src", a.data("src")), t && t.attributes && t.attributes.srcSet && J.o.useSrcset && (s.srcset = t.attributes.srcSet), e = s.src, (t = !!(t && t.attributes && t.attributes.curSrc) && t.attributes.curSrc) && e !== t && a.is(".ls-bg") && (e = t, J.slides[i.slideIndex].data.$background.attr("src", e)), J.preload.preImages.push([e, a])) : "none" !== a.css("background-image") && -1 !== a.css("background-image").indexOf("url") && J.preload.preImages.push([a.css("background-image").match(/url\(['"]?(.+?)['"]?\)/)[1], a])
                }), J.transitions.firstSlide && J.o.globalBGImage && J.preload.preImages.push([J.o.globalBGImage, ie()]), this.thumbnailsAreLoaded || this.thumbnails(), 0 === this.preImages.length ? this.onComplete() : this.start()) : J.slider.shouldResize && t ? (J.resize.setLayers(J.layers.get("next, bg")), J.resize.layers({
                    callback: t
                })) : t && t()
            },
            thumbnails: function() {
            ...
            onComplete: function() {
                ...
                this.onCompleteCallback ? (J.layers.wrap(this.slideIndex), function e() {
                    var t, i, a;
                    0 !== J.slides[s.slideIndex].$layers.length ? J.timeouts.waitForWrap = setTimeout(e, 100) : (delete J.timeouts.waitForWrap, J.functions.setStates(J.transitions.layers.parallax, {
                        ready: !0
                    }), ie(".ls-thumbnail-wrapper, .ls-nav-next, .ls-nav-prev, .ls-bottom-nav-wrapper").css({
                        visibility: "visible"
                    }), J.slides[s.slideIndex].wrapped = !0, t = !(!window._layerSlider.globals.youTubeIsReady && J.layers.get("next,in,youtube,bgvideo").length), i = !(!window._layerSlider.globals.vimeoIsReady && J.layers.get("next,in,vimeo,bgvideo").length), a = function() {
                        J.gui.loadingIndicator.hide(), J.slider.shouldResize ? (J.resize.setLayers(J.layers.get("next, bg")), J.resize.layers({
                            callback: s.onCompleteCallback
                        })) : s.onCompleteCallback()
                    }, t && i ? a() : J.intervals.waitForJSApisLoaded = setInterval(function() {
                        (t || window._layerSlider.globals.youTubeIsReady) && (i || window._layerSlider.globals.vimeoIsReady) && (clearInterval(J.intervals.waitForJSApisLoaded), delete J.intervals.waitForJSApisLoaded, a())
                    }, 50))
            ...
            slider: function(e) {
                ...
                var t, i, a, s = J.slider.$parentWithNumericWidthValue && 0 < J.slider.$parentWithNumericWidthValue.width() && !e ? J.slider.$parentWithNumericWidthValue : J.functions.getSliderClosestParentElementWithNumericValueOfProperty("width"),
                    r = J.slider.initial,
                    o = J.slider.$parentWithNumericWidthValuePercent ? s.width() / 100 * J.slider.$parentWithNumericWidthValuePercent : s.width(),
                    n = r.type,
                    ...
                    case "fullsize":
                        switch (J.o.fullSizeMode.toLowerCase()) {
                            ...
                            case "hero":
                                ...
                                break;
                            case "fitheight":
                                o = s.width() - r.skinWidth, t = s.height() - r.skinHeight;
                                break;
                            case "fitwidth":
                                o = s.width() - r.skinWidth, t = te.viewport.height - r.skinHeight
                        }
            ...
            shadows: function(e, t) {
                for (var i = e.split(" "), a = 0; a < i.length; a++) - 1 !== i[a].indexOf("px") && (i[a] = Math.ceil(parseInt(i[a]) * t) + "px");
            ...
            layers: function(e = {}) {
                if (J.slider.hasPinnedLayers && (J.slider.$layersWrapper.css({
                    ...
                    readyForStart: !0
                }), void(e.callback && (J.api.resumeCallback = e.callback));
                if (e.singleLayer || this.$responsiveLayers) {
                    J.debugMode && J.debug.add("group", "resize");
                    for (var t, i = e.singleLayer || this.$responsiveLayers, a = J.slider.initial, s = J.slider.width, r = J.slider.height, o = s / r, n = [], l = [], d = [], c = [], p = 0, u = 0, h = window.LS_previewZoom || 1, m = 0, f = i.length; m < f; m++) {
                        var g = i[m],
                            y = ie(g),
                            v = y.data(J.defaults.init.dataKey),
                            x = !!v.is.insideLayerGroup && y.data("$layerGroup"),
                            w = !!v.is.insideLayerGroup && x.data(J.defaults.init.dataKey),
                            S = e.original ? ie.extend(!0, {}, v.original, e.original) : v.original,
                            b = this.calculateRatio(v, this.ratio),
                            T = v.elements.$_innerWrappers;
                        S.width || (S.percentWidth = 0), S.height || (S.percentHeight = 0), !y.is("img, picture") || "auto" !== S.width && "auto" !== S.height || ((T = v.elements.$_innerWrappers).addClass("ls-force-display-block ls-force-visibility-hidden"), "auto" === S.width && (S.width = y.width()), "auto" === S.height && (S.height = y.height()), T.removeClass("ls-force-display-block ls-force-visibility-hidden")), t = "responsive" === a.type && -1 !== J.o.maxRatio ? a.width : a.layersWidth, I = "responsive" === a.type && -1 !== J.o.maxRatio ? a.height : a.layersHeight, L = t, u = "fullsize" === a.type || "fullwidth" === a.type || "responsive" === a.type ? (p = 0 < t ? (s - t * b) / 2 : 0, 0 < I ? (r - I * b) / 2 : 0) : (p = p < 0 ? 0 : p, u < 0 ? 0 : u), "0%" !== S.left && "100%" !== S.left || (p = p < 0 ? 0 : p), "0%" !== S.top && "100%" !== S.top || (u = u < 0 ? 0 : u);
                        var k = "fixed" == v.settings.position || "fixedx" == v.settings.position,
                            C = "fixed" == v.settings.position || "fixedy" == v.settings.position,
                            P = s,
                            O = r,
                            I = v.is.insideLayerGroup ? (C = k = !1, W = $ = 0, t = P = w.responsive.width, O = w.responsive.height) : (t = L, I);
                        v.is.pinned && (J.slider.get.offset(), "responsive" !== a.type && "fixedsize" !== a.type && ("fullsize" !== a.type || "fitheight" !== J.o.fullSizeMode && !1 !== J.o.fitScreenWidth) || (k ? (t = P = te.viewport.width, p = 0) : (P = J.slider.width, p = J.slider.offset.left, t = a.width)), C ? (I = O = te.viewport.height, u = 0) : (O = J.slider.height, u = (te.viewport.height - J.slider.height) / 2 || 0, I = a.height));
                        var L, $ = k ? 0 : p,
                            W = C ? 0 : u,
                            M = {
                                width: k && 0 !== S.percentWidth ? P / 100 * S.percentWidth : parseInt(S.width) * b,
                                height: C && 0 !== S.percentHeight ? O / 100 * S.percentHeight : parseInt(S.height) * b,
                                paddingLeft: this.convertSingleValue(S.paddingLeft, b),
                                paddingTop: this.convertSingleValue(S.paddingTop, b),
                                paddingRight: this.convertSingleValue(S.paddingRight, b),
                                paddingBottom: this.convertSingleValue(S.paddingBottom, b),
                                borderLeftWidth: this.convertSingleValue(S.borderLeftWidth, b),
                                borderTopWidth: this.convertSingleValue(S.borderTopWidth, b),
                                borderRightWidth: this.convertSingleValue(S.borderRightWidth, b),
                                borderBottomWidth: this.convertSingleValue(S.borderBottomWidth, b),
                                borderRadius: this.borderRadius(S.borderRadius, b),
                                boxShadow: this.shadows(S.boxShadow, b),
                                textShadow: this.shadows(S.textShadow, b)
                            },
                            B = {
                                marginLeft: this.convertSingleValue(S.marginLeft, b),
                                marginTop: this.convertSingleValue(S.marginTop, b),
                                marginRight: this.convertSingleValue(S.marginRight, b),
                                marginBottom: this.convertSingleValue(S.marginBottom, b)
                            },
                            _ = {},
                            F = {
                                borderRadius: M.borderRadius
                            };
                        if (S.minWidth && (M.minWidth = S.percentMinWidth ? P / 100 * S.percentMinWidth : S.minWidth, M.width = Math.max(M.width, M.minWidth)), S.minHeight && (M.minHeight = S.percentMinHeight ? O / 100 * S.percentMinHeight : S.minHeight, M.height = Math.max(M.height, M.minHeight)), S.maxWidth && (M.maxWidth = S.percentMaxWidth ? P / 100 * S.percentMaxWidth : S.maxWidth, M.width = Math.min(M.width, M.maxWidth)), S.maxHeight && (M.maxHeight = S.percentMaxHeight ? O / 100 * S.percentMaxHeight : S.maxHeight, M.height = Math.min(M.height, M.maxHeight)), S.minWidth && S.maxWidth && M.minWidth > M.maxWidth && (M.width = M.minWidth), S.minHeight && S.maxHeight && M.minHeight > M.maxHeight && (M.height = M.minHeight), v.is.imageLayer && (M.minWidth || M.minHeight || M.maxWidth || M.maxHeight) && (T.addClass("ls-force-display-block ls-force-visibility-hidden"), L = {
                                minHeight: M.minHeight || 0,
                                minWidth: M.minWidth || 0,
                                maxHeight: M.maxHeight || "none",
                                maxWidth: M.maxWidth || "none"
                            }, !v.original.autoWidth || M.minWidth && !M.minHeight || M.maxWidth && !M.maxHeight ? L.width = M.width : L.width = "auto", !v.original.autoHeight || !M.minWidth && M.minHeight || !M.maxWidth && M.maxHeight ? L.height = M.height : L.height = "auto", y.css(L), M.width = y.width(), M.height = y.height(), delete M.minWidth, delete M.minHeight, delete M.maxWidth, delete M.maxHeight, T.removeClass("ls-force-display-block ls-force-visibility-hidden")), (k || C) && (S.percentHeight || S.percentWidth) && v.is.imageLayer && (S.percentHeight && !S.percentWidth && (M.width = S.width * (M.height / S.height)), S.percentWidth && !S.percentHeight && (M.height = S.height * (M.width / S.width))), ("number" == typeof S.width && S.width < 0 || "auto" == S.width || "" == S.sWidth) && J.debugMode && J.debug.add("warn", "resize.width", [m + 1, S.width]), ("number" == typeof S.height && S.height < 0 || "auto" == S.height || "" == S.sHeight) && J.debugMode && J.debug.add("warn", "resize.height", [m + 1, S.height]), M.fontSize = S.fontSize * b, v.is.textLayer && (te.isMobile && M.fontSize < v.styleSettings.minmobilefontsize ? M.fontSize = v.styleSettings.minmobilefontsize : M.fontSize < v.styleSettings.minfontsize && (M.fontSize = v.styleSettings.minfontsize), T = M.fontSize / S.fontSize, M.fontSize += "px", -1 !== S.lineHeight.indexOf("px") && (M.lineHeight = parseFloat(S.lineHeight) * T + "px"), -1 !== S.letterSpacing.indexOf("px") && (M.letterSpacing = parseFloat(S.letterSpacing) * T + "px"), -1 !== S.textStrokeWidth.indexOf("px") && (M.textStrokeWidth = parseFloat(S.textStrokeWidth) * T + "px"), "" == S.sWidth && (M.width = "auto", v.elements.$innerWrapper.addClass("ls-force-width-auto"), "nowrap" !== y.css("white-space") && (v.elements.$_innerWrappers.addClass("ls-force-left-0"), v.elements.$_outerWrappers.addClass("ls-force-full-size"))), "" == S.sHeight && (M.height = "auto", v.elements.$innerWrapper.addClass("ls-force-height-auto")), "" != S.sWidth && "" != S.sHeight || y.css(M)), v.is.slideBackground || v.is.backgroundVideo)
                            if (v.is.slideBackground) {
                                ...
                                switch ((void 0 !== A && "inherit" !== A ? A : J.o.slideBGSize).replace("100% 100%", "stretch")) {
                                    case "auto":
                                        break;
                                    case "cover":
                                        S.ratio < o ? (M.width = s, M.height = M.width / S.ratio) : (M.height = r, M.width = M.height * S.ratio);
                                        break;
                                    case "contain":
                                        S.ratio < o ? (M.height = r, M.width = M.height * S.ratio) : (M.width = s, M.height = M.width / S.ratio);
                                        break;
                                    case "stretch":
                                        M.width = s, M.height = r
                                }
                                M.width = Math.round(M.width), M.height = Math.round(M.height);
                                var z, D = J.slides[v.is.onSlide].data.backgroundPosition;
                                switch ((z = (void 0 !== D ? D : J.o.slideBGPosition).split(" "))[0]) {
                                    case "left":
                                        M.x = 0;
                                        break;
                                    case "center":
                                        M.x = (J.slider.width - M.width) / 2;
                                        break;
                                    case "right":
                                        M.x = J.slider.width - M.width;
                                        break;
                                    default:
                                        -1 !== z[0].indexOf("%") ? M.x = (J.slider.width - M.width) / 100 * parseInt(z[0]) : M.x = parseInt(z[0])
                                }
                                if (void 0 !== z[1]) switch (z[1]) {
                                    case "top":
                                        ...
                                        break;
                                    case "center":
                                        M.y = (J.slider.height - M.height) / 2;
                                        break;
                                    case "bottom":
                                        M.y = J.slider.height - M.height;
                                        break;
                                    default:
                                        -1 !== z[1].indexOf("%") ? M.y = (J.slider.height - M.height) / 100 * parseInt(z[1]) : M.y = parseInt(z[1])
                                }
                                M.transform = "translateX(" + M.x + "px) translateY(" + M.y + "px)", M["-ms-transform"] = "translateX(" + M.x + "px) translateY(" + M.y + "px)", M["-webkit-transform"] = "translateX(" + M.x + "px) translateY(" + M.y + "px)"
                            } else v.is.backgroundVideo && (S.ratio < o ? (M.width = s, M.height = M.width / S.ratio) : (M.height = r, M.width = M.height * S.ratio), M.x = (J.slider.width - M.width) / 2, M.y = (J.slider.height - M.height) / 2, M.width = Math.round(M.width), M.height = Math.round(M.height), M.transform = "translateX(" + M.x + "px) translateY(" + M.y + "px)", M["-ms-transform"] = "translateX(" + M.x + "px) translateY(" + M.y + "px)", M["-webkit-transform"] = "translateX(" + M.x + "px) translateY(" + M.y + "px)");
                        else !v.mediaProperties || "youtube" !== v.mediaProperties.type && "vimeo" !== v.mediaProperties.type || (A = M.width / M.height, D = {
                            width: M.width,
                            height: M.height
                        }, S.ratio < A ? (D.height = M.width / S.ratio, D.marginTop = (M.height - D.height) / 2) : (D.width = M.height * S.ratio, D.marginLeft = (M.width - D.width) / 2), v.mediaProperties.$media.css(D)), v.elements.$_innerWrappers.addClass("ls-force-display-block ls-force-no-transform"), y.addClass("ls-force-no-transform"), v.is.insideLayerGroup && ((w = (x = y.data("$layerGroup")).data(J.defaults.init.dataKey)).elements.$_innerWrappers.addClass("ls-force-display-block ls-force-no-transform"), x.addClass("ls-force-no-transform")), "auto" == M.width ? M.outerWidth = Math.ceil(y.outerWidth()) : M.outerWidth = M.width + J.layers.toNum(M.paddingLeft, M.fontSize) + J.layers.toNum(M.paddingRight, M.fontSize) + J.layers.toNum(M.borderLeftWidth, M.fontSize) + J.layers.toNum(M.borderRightWidth, M.fontSize), "auto" == M.height ? M.outerHeight = Math.ceil(y.outerHeight()) : M.outerHeight = M.height + J.layers.toNum(M.paddingTop, M.fontSize) + J.layers.toNum(M.paddingBottom, M.fontSize) + J.layers.toNum(M.borderTopWidth, M.fontSize) + J.layers.toNum(M.borderBottomWidth, M.fontSize), v.elements.$_allWrappers.removeClass("ls-force-display-block ls-force-no-transform ls-force-width-auto ls-force-height-auto ls-force-left-0 ls-force-full-size"), y.removeClass("ls-force-no-transform"), v.is.insideLayerGroup && (w.elements.$_allWrappers.removeClass("ls-force-display-block ls-force-no-transform ls-force-width-auto ls-force-height-auto ls-force-left-0 ls-force-full-size"), x.removeClass("ls-force-no-transform")), B.width = _.width = M.outerWidth, B.height = _.height = M.outerHeight, -1 != S.left.indexOf("%") ? "100%" === S.left ? M.left = 0 === $ ? P / 100 * parseFloat(S.left) - M.outerWidth : $ + t * b / 100 * parseFloat(S.left) - M.outerWidth : "0%" === S.left ? M.left = 0 === $ ? 0 : $ : M.left = 0 === $ ? P / 100 * parseFloat(S.left) - M.outerWidth / 2 : $ + t * b / 100 * parseFloat(S.left) - M.outerWidth / 2 : M.left = $ + parseFloat(S.left) * b, B.left = M.left, -1 != S.top.indexOf("%") ? "100%" === S.top ? M.top = 0 === W ? O / 100 * parseFloat(S.top) - M.outerHeight : W + I * b / 100 * parseFloat(S.top) - M.outerHeight : "0%" === S.top ? M.top = 0 === W ? 0 : W + 0 : M.top = 0 === W ? O / 100 * parseFloat(S.top) - M.outerHeight / 2 : W + I * b / 100 * parseFloat(S.top) - M.outerHeight / 2 : M.top = W + parseFloat(S.top) * b, B.top = M.top;
                        v.textIn.$nodesForBackgroundClip && v.textIn.$nodesForBackgroundClip.length && ((O = v.elements.$outerStyleWrapper.add(v.elements.$outerStyleWrapper.find(".ls-wrapper"))).addClass("ls-force-visibility-hidden ls-force-display-block"), v.elements.$_innerWrappers.addClass("ls-force-no-transform"), I = !1, "auto" === g.style.width && (g.style.width = Math.ceil(v.original.width * (h * b)) + "px", I = !0), v.textIn.$nodesForBackgroundClip.each(function(e, t) {
                            var i = ie(t),
            ...
            performTransformOperations: function(e, t) {
                ...
                for (r in t)
                    if ("string" == typeof t[r] && -1 !== t[r].indexOf("="))
                        if (a = (i = t[r].split("="))[0].trim() || !1, s = parseFloat(i[1].trim()) || !1, a && s && ie.isNumeric(s)) switch (a) {
                            case "+":
                                t[r] = e[r] + s;
                                break;
                            case "-":
            ...
            transformProperties: function(e, t, i, a, s, r) {
                if ("object" == typeof a.x) {
                    ...
                    i.cycle.x = o
                } else "string" == typeof a.x ? -1 !== a.x.indexOf("random") || a.x.charAt(0) === J.defaults.init.openingBracket ? i.x = J.functions.convert.randomProperties(a.x, "x", e, t) : i.x = this.getXY(e, t, a.x, "Width") : void 0 !== a.x && (i.x = a.x * t.settings.calculatedratio);
                if ("object" == typeof a.y) {
                    ...
                    i.cycle.y = l
                } else "string" == typeof a.y ? -1 !== a.y.indexOf("random") || a.y.charAt(0) === J.defaults.init.openingBracket ? i.y = J.functions.convert.randomProperties(a.y, "y", e, t) : i.y = this.getXY(e, t, a.y, "Height") : void 0 !== a.y && (i.y = a.y * t.settings.calculatedratio);
                if (s && (i = s), "object" == typeof a.transformOrigin || r) {
                    var c = [];
                    if (r) {
                        s = e.data(J.defaults.init.dataKey).elements.$outerStyleWrapper.add(e.data(J.defaults.init.dataKey).elements.$outerStyleWrapper.find(".ls-wrapper"));
                        s.addClass("ls-force-visibility-hidden ls-force-display-block ls-fix-textnodes"), c = J.functions.convert.nodesTransformOrigin(a.transformOrigin, r, t, e.data(J.defaults.init.dataKey).elements.$outerStyleWrapper), s.removeClass("ls-force-visibility-hidden ls-force-display-block ls-fix-textnodes")
                    } else
                        for (var p = 0; p < a.transformOrigin.length; p++) c[p] = J.functions.convert.transformOrigin(a.transformOrigin[p], e, t, e.data(J.defaults.init.dataKey).elements.$outerStyleWrapper);
                    i.cycle.transformOrigin = c
                } else "string" == typeof a.transformOrigin && (i.transformOrigin = J.functions.convert.transformOrigin(a.transformOrigin, e, t, e.data(J.defaults.init.dataKey).elements.$outerStyleWrapper))
            },
            styleProperties: function(e, t, i, a) {
                a.width && -1 !== a.width.indexOf("%") && (a.percentWidth = parseInt(a.width), a.width = parseInt(J.layers.getStyle(a.width, J.slider.initial.percW))), a.height && -1 !== a.height.indexOf("%") && (a.percentHeight = parseInt(a.height), a.height = parseInt(J.layers.getStyle(a.height, J.slider.initial.percH)));
                var s, r = J.resize.layers({
                    singleLayer: e,
                    original: a
                })[0];
                for (s in a) - 1 === s.indexOf("percent") && r.hasOwnProperty(s) && -1 === r[s].indexOf("NaN") && (i[s] = r[s])
            },
            getXY: function(e, t, i, a, s) {
                var r = 0,
                    o = t.original,
                    n = t.responsive,
                ...
                if (n.outerWidth || (n.outerWidth = Math.ceil(e.outerWidth())), n.outerHeight || (n.outerHeight = Math.ceil(e.outerHeight())), o && n && l) switch (i) {
                    ...
                    case "-height":
                        ...
                        break;
                    default:
                        r = -1 !== i.indexOf("%") ? n["outer" + a] / 100 * parseInt(i) : -1 !== i.indexOf("sw") ? parseFloat(i.split("sw")[0]) / 100 * J.slider.width : -1 !== i.indexOf("sh") ? parseFloat(i.split("sh")[0]) / 100 * J.slider.height : -1 !== i.indexOf("lw") ? n.outerWidth / 100 * parseFloat(i.split("lw")[0]) : -1 !== i.indexOf("lh") ? n.outerHeight / 100 * parseFloat(i.split("lh")[0]) : parseFloat(i) * (s ? 1 : t.settings.calculatedratio || this.calculateRatio(t, this.ratio))
                }
                return r
            },
            navigation: function() {
            ...
            slide: {
                ...
                start: function(e) {
                    var t, i = !(!J.slides.current.index || !J.slides.current.data.$backgroundVideo.length),
                        a = !(!J.slides.next.index || !J.slides.next.data.$backgroundVideo.length);
                    ...
                    0 < r ? r = 0 : Math.abs(r) > e && (r = -e), J.transitions.firstSlide && J.o.animateFirstSlide && !1 !== J.o.firstSlideTimeShift && J.o.firstSlideTimeShift <= 0 && (r = J.o.firstSlideTimeShift / 1e3), J.transitions.nextSlide.data.calculatedTimeShift = r, r = J.transitions.firstSlide && !J.o.animateFirstSlide ? J.o.sliderFadeInDuration + .01 : (s + r) * J.transitions._slideTransition.timeScale(), (i || a) && J.transitions.media.changeBackgroundVideo(J.transitions.firstSlide, i && a), J.transitions._slideTransition.call(function() {
                ...
                normal: {
                    select: {
                        ...
                        transition: function(e, t) {
                            ...
                            var i, a, s = -1 == e.indexOf("custom") ? J.t : J.ct,
                                r = "3d"; - 1 != e.indexOf("2d") && (r = "2d"), a = -1 != t.indexOf("last") ? s["t" + r].length - 1 : -1 != t.indexOf("all") ? Math.floor(Math.random() * J.functions.countProp(s["t" + r])) : (t = (i = t.split(",")).length, parseInt(i[Math.floor(Math.random() * t)]) - 1), void 0 === s["t" + r][a] && (J.debugMode && J.debug.add("warn", "slideTransition.customTransition", [r.toUpperCase() + (-1 === e.indexOf("custom") ? "" : " (CUSTOM)"), a + 1]), s = J.t, e = r = "2d", a = 0), J.debugMode && J.debug.add("log", "slideTransition.info", [r.toUpperCase() + (-1 === e.indexOf("custom") ? "" : " (CUSTOM)"), a + 1, s["t" + r][a].name]), J.transitions.slide.normal.setTransition(r, s["t" + r][a])
                        }
                    },
                    setTransition: function(e, t) {
                        t.name || (t = _lsConvTrProp(t));
                        var i, a, s, r, o, n = ie.extend(!0, {
                                cols: 1,
                                rows: 1
                            }, t),
                            l = typeof n.cols,
                        ...
                        if (n.rc) {
                            switch (typeof n.rc) {
                                case "number":
                                    ...
                                    break;
                                case "string":
                                    s = parseInt(n.rc), l = Math.floor(J.slider.width / s), d = Math.floor(J.slider.height / s)
                            }
                            n.cols = l, n.rows = d
                        } else {
                            switch (l) {
                        ...
                        J.debugMode && !J.o.slideTransition && (J.debug.add("log", "slideTransition.properties", [
                            [l, d], l * d
                        ]), J.debug.groupEnd()), i = Math.floor(J.slider.width / l), a = Math.floor(J.slider.height / d), l = Math.floor(J.slider.width / i), d = Math.floor(J.slider.height / a), r = J.slider.width - i * l, o = J.slider.height - a * d, "prev" == p && (t = {
                            random: "random",
                            forward: "reverse",
                            reverse: "forward",
                            center: "center",
                        ...
                        for (var y, v, x = 0; x < l * d; x++) c.push(x);
                        ...
                        for (var w = 0; w < l * d; w++) {
                            ...
                            if ("3d" == e) {
                                ...
                                switch (-1 != n.name.toLowerCase().indexOf("mirror") && w % 2 == 0 && (p = "prev" == p ? "next" : "prev"), "prev" == p && (Z = {
                                    top: "bottom",
                                    bottom: "top",
                                    middle: "middle",
                                    left: "right",
                                    ...
                                    case "top":
                                        R = N = -k.data("style").height, E = H = 0;
                                        break;
                                    case "bottom":
                                        R = N = k.data("style").height, E = H = 0;
                                        break;
                                    case "left":
                                        R = N = 0, E = H = -k.data("style").width;
                                        break;
                                    case "right":
                                        R = N = 0, E = H = k.data("style").width;
                                        break;
                                    case "topleft":
                                        R = k.data("style").height, N = 0, E = k.data("style").width, H = 0;
                                        break;
                                    case "topright":
                                        R = k.data("style").height, N = 0, E = -k.data("style").width, H = 0;
                                        break;
                                ...
                                switch (this.scale2D = void 0 !== n.transition.scale ? n.transition.scale : 1, 1 == y && 1 != this.scale2D && (R /= 2, N /= 2, E /= 2, H /= 2), (n.transition.rotate || n.transition.rotateX || n.transition.rotateY || 1 != this.scale2D) && "slide" != n.transition.type ? k.css({
                                    overflow: "visible"
                                }) : k.css({
                                    overflow: "hidden"
                                    ...
                                    overflow: "hidden"
                                }), !0 === v || "slide" == n.transition.type || "scale" == n.transition.type || !0 === y || n.transition.hasOwnProperty("opacity") ? (D = k.appendTo(this.$curTiles), F = k.clone().appendTo(this.$nextTiles), O = ie("<div>").addClass("ls-curtile").appendTo(D)) : F = k.appendTo(this.$nextTiles), $ = ie("<div>").addClass("ls-nexttile").appendTo(F), A = c[w] * n.tile.delay / 1e3, L = n.transition.rotate || 0, z = n.transition.rotateX || 0, D = n.transition.rotateY || 0, "prev" == p && (L = -L, z = -z, D = -D), n.transition.type) {
                                    case "fade":
                                        Y = R = N = E = H = 0, X = 1;
                                        break;
                                    case "mixed":
                                        Y = 0, (X = 1) == this.scale2D && (N = H = 0), W = void 0 !== n.transition.scaleX ? n.transition.scaleX : void 0 !== n.transition.scale ? n.transition.scale : 1, M = void 0 !== n.transition.scaleY ? n.transition.scaleY : void 0 !== n.transition.scale ? n.transition.scale : 1;
                                        break;
                                    case "scale":
                                        switch (Y = R = N = E = H = 0, M = W = X = 1, Z) {
                                            case "left":
                                            case "right":
                                                W = 1 + c[w] / (50 / Q);
                                                break;
                                        ...
                                        switch ("mirror" === n.tile.sequence && l * d / 2 < w && (j = 100, G = 0), Z) {
                                            case "left":
                                                K = j + "% 50%", U = G + "% 0";
                                                break;
                                            case "right":
                                ...
                                J.transitions._slideTransition.fromTo($[0], n.transition.duration / 1e3, {
                                    ...
                                    css: {
                                        ...
                                        scaleX: void 0 !== W ? W : this.scale2D,
                            ...
                            V = w % l * i, q = Math.floor(w / l) * a, void 0 !== J.transitions.curSlide.data.$background && (S = J.transitions.curSlide.data.$background.data(J.defaults.init.dataKey), "3d" === e || "2d" === e && (!0 === v || "slide" === n.transition.type || "scale" === n.transition.type || !0 === y || n.transition.hasOwnProperty("opacity")) ? O.append(ie('<div style="position: absolute;">').css({
                                width: J.slider.width,
                                height: J.slider.height,
                                left: -V,
                                top: -q,
                                ...
                                filter: S.responsive.filter,
                                transform: "translateX(" + S.responsive.x + "px) translateY(" + S.responsive.y + "px)"
                            })))), "transparent" === J.transitions.curSlide.data.backgroundColor || J.transitions.curSlide.data.$backgroundVideo.length || ("3d" === e || "2d" === e && (!0 === v || "slide" === n.transition.type || !0 === y) ? O : this.$curTiles).css("background-color", J.transitions.curSlide.data.backgroundColor), void 0 !== J.transitions.nextSlide.data.$background && (S = (A = J.transitions.nextSlide.data.$background.data(J.defaults.init.dataKey)).kenBurns[g], $.append(ie('<div style="position: absolute;">').css({
                                width: J.slider.width,
                                height: J.slider.height,
                                left: -V,
                                top: -q,
            ...
            layers: {
                ...
                out: {
                    forced: function() {
                        var s, r, o, n, e, t, i;
                        J.transitions._forceLayersOut && (J.transitions._slideTimeline && (s = new ee.TimelineMax({
                            paused: !0,
                        ...
                        }), s.play().seek(100), J.transitions._slideTimeline.eventCallback("onStart", null), J.transitions._slideTimeline.eventCallback("onComplete", null), J.transitions._slideTimeline.eventCallback("onReverseComplete", null), J.transitions._slideTimeline.eventCallback("onUpdate", null), J.transitions._slideTimeline.stop().clear(), J.transitions._slideTimelineAlternate.stop().clear()), ("prev" === J.navigation.direction ? J.transitions._forceLayersOutMirror : J.transitions._forceLayersOut).play(), J.slideshow.forceFastChange && (J.transitions._forceLayersOut.progress(1), J.transitions._forceLayersOutMirror.progress(1))), J.slider.$layersWrapper.find(".ls-link").css({
                            display: "none"
                        })
                    },
                    onStart: function(e) {
                ...
                reset: function(e, t) {
                    var i;
                    t.original._zIndex && J.transitions.layers.setZIndex(e, t, t.original._zIndex), t.loop._timeline && (t.loop._timeline.stop().clear(), delete t.loop._timeline, ee.TweenMax.set(t.elements.$loopWrapper[0], t.reset.loopWrapperOnSlideChange)), t.clip.enabled && (i = t.clip.userDefined ? t.clip.default : t.clip.style, t.loop.enabled && ee.TweenMax.set(t.elements.$loopWrapper[0], i), t.inClipFromCSS.clipPath || ee.TweenMax.set(t.elements.$clipWrapper[0], i)), ee.TweenMax.set(t.elements.$wrapper[0], t.reset.wrapperOnSlideChange), ee.TweenMax.set(e[0], {
                ...
                timeline: {
                    ...
                    create: function(e) {
                        ...
                        if (J.transitions.curNext = s, J.o.allowRestartOnResize ? J.slider.isScrollScene && (J.transitions.layers.timeline.shouldRestart = !0) : J.transitions.layers.timeline.shouldRestart = !1, J.transitions.layers.timeline.resetStates(), J.transitions.timelines.set("layers", function(e, t) {
                        ...
                        for (var r, o = 0; o < a.length; o++) ie(a[o]).data(J.defaults.init.dataKey).parallax.enabled && ie(a[o]).data(J.defaults.init.dataKey).elements.$parallaxWrapper.attr("data-ls-parallax", "active");
                    ...
                    getTiming: function(e, t, i, a) {
                        ...
                        t = t.toLowerCase();
                        var s, r, o, n, l, d = J.defaults.layer.timelineHierarchy,
                            c = 0;
                        if (-1 !== t.indexOf("*") && (l = "*"), -1 !== t.indexOf("/") && (l = "/"), -1 !== t.indexOf("+") && (l = "+"), -1 !== t.indexOf("-") && (l = "-"), l)
                            if (n = t.split(l), s = ie.trim(n[0]), o = parseInt(ie.trim(n[1])), d[s] && -1 !== d[i][1].indexOf(d[s][0])) {
                            ...
                            } else J.debugMode && (d[s] || J.debug.add("warn", "layerTransition.timing1", s), -1 === d[i][1].indexOf(d[s][0]) && J.debug.add("warn", "layerTransition.timing3", [s, d[s], i, d[i]])), "+" !== l && !a || (c = o / 1e3);
                        else d[s = ie.trim(t)] && -1 !== d[i][1].indexOf(d[s][0]) ? c = a ? 0 : "number" == typeof e.timeline[s] ? e.timeline[s] : e.timeline[s](e) : J.debugMode && (d[s] ? -1 === d[i][1].indexOf(d[s][0]) && J.debug.add("warn", "layerTransition.timing3", [s, d[s], i, d[i]]) : J.debug.add("warn", "layerTransition.timing1", s));
                        return (c != c || c < 0) && (J.debugMode && J.debug.add("warn", "layerTransition.timing2", [i, s, c]), c = 0), c
                    },
                    addLayers: function(e, t, i, a, s, r) {
                        for (var o = 0, n = e.length; o < n; o++) {
                            var l, d, c, p, u, h = e[o],
                                ...
                                x = f.elements.$parallaxWrapper,
                                w = (f.elements.$scrollWrapper, f.elements.$scrollTransformWrapper, f.settings.skipViewport && J.slideshow.state.changed < 1 ? s : i),
                                S = "loop" == f.settings.skipViewport && J.slideshow.state.changed < 1 ? s : i,
                                b = ie.extend(!0, {}, f.inLayerFrom),
                                T = b.css,
                                ...
                                W = ie.extend(!0, {}, f.textOutShouldBeConverted);
                            if (f.should.reset && J.transitions.layers.reset(m, f), m.hasClass("ls-bg")) f.kenBurns.zoom && i.fromTo(m.closest(".ls-bg-wrap"), J.transitions.nextSlide.data.duration + J.transitions.nextSlide.data.calculatedTimeShift, {
                            ...
                            }, -J.transitions.nextSlide.data.calculatedTimeShift), ie.isEmptyObject(f.filter.values.bgFrom) && ie.isEmptyObject(f.filter.values.bgTo) || (f.filter.transitions.bg || (f.filter.transitions.bg = J.transitions.layers.filters.createTransition(f, "bg", f.filter.values.bgFrom, f.filter.values.bgTo)), w.to([{
                                p: 0
                                ...
                                case "in":
                                    if (f.in.enabled ? (f.settings.timelineIsCalculated && !f.settings.recalculateTimeline || ("startAtFirst" == f.settings.recalculateTimeline && (f.settings.recalculateTimeline = !1, f.settings.timelineIsCalculated = !1), "number" != typeof f.in.startAt && (f.in.startAt = 0), "number" != typeof f.in.startAtFirst && (f.in.startAtFirst = 0), f.timeline.transitioninstart = J.transitions.firstSlide && f.in.startAtFirst ? f.in.startAtFirst : f.in.startAt, f.timeline.transitioninend = f.timeline.transitioninstart + f.in.duration), J.transitions.firstSlide && f.in.startAtFirst && (f.settings.recalculateTimeline = "startAtFirst"), J.resize.performTransformOperations(f.inLayerToCSS, T), f.in.mirror && "prev" === J.navigation.direction && J.resize.mirrorTransitionProperties({
                                        ...
                                        }, f.timeline.textinstart + .001, [h]), w.addCallback(function(e) {
                                            J.layers.set.dataAttribute("add", e, "text-animating-in")
                                        }, f.timeline.textinstart, [m]), w.staggerFromTo(f.textIn.nodes, f.textIn.duration, I, f.textInNodesTo, f.textIn.shiftNodes, f.timeline.textinstart, function(e) {
                                        ...
                                        switch (f.settings.timelineIsCalculated && !f.is.static || (f.timeline.autoparallaxstart = this.getTiming(f, f.parallax.startAt, "autoparallaxstart"), f.timeline.autoparallaxend = -1 !== f.parallax.count && f.timeline.autoparallaxstart + f.parallax.duration * f.parallax.count), f.parallax._timeline = M, f.parallax.dummy = {
                                            ...
                                            case "linear-h":
                                                ...
                                                B.x = 10,
                                                B.ease = ee.Quad.easeInOut,
                                                B.yoyo = !0,
                                                B.repeat = -1 == f.parallax.count ? -1 : 2 * f.parallax.count - 1;
                                                break;
                                            case "linear-v":
                                                    f.parallax.dummy = {
                                                    x: 0,
                                        ...
                                        }, B.onUpdateParams = ["{self}", f.parallax.dummy, x[0], f.parallax.distance, f.parallax.level, f.parallax.type, f.parallax.rotation], M.to(f.parallax.dummy, -1 == f.parallax.path.indexOf("linear") ? f.parallax.duration : f.parallax.duration / 2, B), i.addCallback(function(e) {
                                            e.play()
                                    ...
                                    }, 0), f.loopClipToCSS.clipPath && (f.loopClipToCSS.clipPath = J.functions.convert.clipProperties(f.loopClipToCSS.clipPath, f, m), c.fromTo(v[0], f.loop.duration, f.loopClipFrom, f.loopClipTo, 0)), -1 !== f.loop.repeat && ("looplayers" === J.o.pauseOnHover || J.gui.timers.slidebar.$element || J.o.playByScroll) ? (S.add(c, f.timeline.loopstart), c.play()) : S.addCallback(function(e) {
                                        e.play()
                                ...
                                case "out":
                                    f.is.textLayer && f.textOut.enabled && (p = J.transitions.layers.splitType.setNodesSequence(f.textOut.type.split("_"), f.textOut.ns), f.textOut.nodes = p[0], J.resize.transformProperties(m, f, f.textOutNodesTo, f.textOutShouldBeConverted, f.textOutNodesFrom, f.textOut.nodes), f.textOut.mirror ? (f.textOut.nodesMirror = p[1], J.resize.mirrorTransitionProperties({
                                        ...
                                        transitionPropertiesShouldBeConverted: W,
                                        transitionType: "text",
                ...
                hover: {
                    ...
                    createTimeline: function(e, t) {
                        ...
                        }), t.hover._linkTween = ee.TweenMax.fromTo(i[0], t.hover.durationIn, a, s), t.hover._timeline.add(t.hover._linkTween, 0)) : t.hover._linkTween = null, t.hover.alwaysOnTop && (s = {
                            zIndex: 9999
                        }, J.browser.isSafari && (s.transform = "translateZ(999999px)"), t.hover._timeline.to(t.elements.$outerWrapper[0], t.hover.durationIn, {
                            autoCSS: !1,
                            css: s
                ...
                parallax: {
                    ...
                    init: function() {
                        ...
                        }), M.on("scroll.parallax" + W + " touchmove.parallax" + W, function() {
                            (t.wrappers.scroll.$2d.length || t.wrappers.scroll.$3d.length) && (t.state.paused || t.scroll())
                        }), M.on("resize.parallax" + W, function() {
                    ...
                    addShadow: function() {
                        var e, t, i, a = J.gui.shadow.$element,
                            s = (J.slides.current && J.slides.current.parallax ? J.slides.current : J.slides.next).index;
                        J.slides[s].data.$background && J.slides[s].data.$background.data(J.defaults.init.dataKey).parallax.enabled && J.slides[s].data.overflow && "hidden" !== J.slides[s].data.overflow && (e = "50% -" + .25 * J.slider.height + "px 0", i = void 0 !== (t = J.slides[s].data.$background.data(J.defaults.init.dataKey).parallax).rotation ? 2 * t.rotation : void 0 !== J.slides[s].parallax.rotation ? 2 * J.slides[s].parallax.rotation : 2 * this.defaultProperties.rotation, a.data(J.defaults.init.dataKey, {
                            parallax: ie.extend(!0, {}, this.defaultProperties, J.slides[s].parallax, {
                                level: t.level,
                                transformOrigin: e,
                                rotation: i
                            })
                        }), a.attr("data-ls-parallax", "active"), ee.TweenMax.set(a[0], {
                            transformOrigin: e,
                            transformPerspective: a.data(J.defaults.init.dataKey).parallax.transformPerspective * J.resize.ratio
                        }), "3d" === J.slides[s].parallax.type || "3d" === t.type ? this.wrappers.cursor.$3d = this.wrappers.cursor.$3d.add(a) : this.wrappers.cursor.$2d = this.wrappers.cursor.$2d.add(a)), this.shadowIsChecked = !0
                    },
                    ...
                    calculateTransformProperties: function() {
                        ie().add(this.wrappers.cursor.$2d).add(this.wrappers.cursor.$3d).add(this.wrappers.scroll.$2d).add(this.wrappers.scroll.$3d).add(this.wrappers.auto.$2d).add(this.wrappers.auto.$3d).each(function() {
                            var e = ie(this),
                                ...
                                i = e.find(".ls-layer"),
                                a = i.data(J.defaults.init.dataKey);
                            ee.TweenMax.set(ie(this)[0], {
                                transformOrigin: J.functions.convert.transformOrigin(t.transformOrigin, i.data(J.defaults.init.dataKey).elements.$wrapper, a, e),
                                transformPerspective: t.transformPerspective * a.settings.calculatedratio
                            })
                        }), this.transformPropertiesCalculated = !0
                    },
                    trigger: function() {
                        M.trigger("scroll.parallax" + W), M.trigger("touchmove.parallax" + W)
                    },
                    auto: function() {
                    ...
                    animate2D: function(s, r, e) {
                        this.wrappers[e].$2d.each(function() {
                            var e, t, i, a = ie(this);
                            "active" === a.attr("data-ls-parallax") && (t = (e = a.data(J.defaults.init.dataKey).parallax).x ? -s * (e.distance / 2e3) * parseInt(e.level) : 0, i = e.y ? -r * (e.distance / 2e3) * parseInt(e.level) : 0, ee.TweenMax.to(a[0], e.durationMove, {
                                x: t,
                                y: i
                            }))
                        })
                    ...
                    animate3D: function(o, n, e) {
                        this.wrappers[e].$3d.each(function() {
                            var e, t, i, a, s, r = ie(this);
                            "active" === r.attr("data-ls-parallax") && (a = (e = r.data(J.defaults.init.dataKey).parallax).x ? (i = -o / (4e3 / e.rotation), -o * (e.distance / 2e3) * parseInt(e.level)) : i = 0, s = e.y ? (t = n / (4e3 / e.rotation), -n * (e.distance / 2e3) * parseInt(e.level)) : t = 0, ee.TweenMax.to(r[0], e.durationMove, {
                                rotationX: t,
                                rotationY: i,
                                x: a,
                                y: s
                ...
                scroll: {
                    ...
                    init: function() {
                        var e = this;
                        M.on("scroll.scroll" + W + " touchmove.scroll" + W, function() {
                            e.$wrappers.length && e.scroll()
                        }), M.on("resize.scroll" + W, function() {
                    ...
                    scroll: function(o) {
                        ...
                        J.slider.state.isNotDisplayed || J.slider.state.isHidden || (l = (n = this).getCenter(this.defaults.centerLayers), this.transformPropertiesCalculated || this.calculateTransformProperties(), this.$wrappers.each(function() {
                            var e, t, i, a = ie(this),
                                s = a.find(".ls-scroll-transform"),
                                r = a.data(J.defaults.init.dataKey).scroll;
                    ...
                    calculateTransformProperties: function() {
                        ...
                        this.$wrappers.each(function() {
                            var e = ie(this),
                                ...
                                i = (e.find(".ls-layer").data(J.defaults.init.dataKey), a.setCenter(t, a.getCenter(a.defaults.centerLayers))),
                                i = a.setY(t, i) <= 0 ? "+" : "-";
                            a.setTransformProperties(e, t, i)
                        }), this.transformPropertiesCalculated = !0
                    },
                    setTransformProperties: function(e, t, i) {
                        var a = e.find(".ls-layer"),
                            s = a.data(J.defaults.init.dataKey);
                        ee.TweenMax.set(e.find(".ls-scroll-transform")[0], {
                            transformOrigin: J.functions.convert.transformOrigin("+" === i ? t.shouldBeConverted.transformOrigin : t.shouldBeConverted.transformOriginAlt, e, s, a),
                ...
                filters: {
                    createTransition: function(e, t, i, a) {
                        var s, r = new J.defaults.layer.properties.filter,
                            o = {};
                        for (s in r) switch (t) {
                            case "in":
                ...
                splitType: {
                    ...
                    resetNodes: function(e, t) {
                        ie(".ls-ch, .ls-wd, .ls-ln", e).add(t.elements.$wrapper).css({
                            transform: "none",
                            opacity: 1
                        }).each(function() {
                    ...
                    setRandomProperties: function(e, t, i, a, s) {
                        for (var r in i) {
                            for (var o = [], n = 0, l = t["text" + s].nodes.length; n < l; n++) o[n] = J.functions.convert.randomProperties(i[r], r, e, t);
                            delete a[r], a.cycle[r] = o
                        }
                        i = null
                    }
                }
            ...
            media: {
                ...
                changeBackgroundVideo: function(e, t) {
                    ...
                    }))), J.slides.next.data.$backgroundVideo.length && (s = (a = J.slides.next.data.$backgroundVideo).data(J.defaults.init.dataKey).elements.$bgWrapper, r = a.data(J.defaults.init.dataKey).elements.$bgOuterWrapper, te.isMobile && ($.hasClass("ls-device-is-phone") && r.hasClass("ls-hide-on-phone") || $.hasClass("ls-device-is-tablet") && r.hasClass("ls-hide-on-tablet")) || setTimeout(function() {
                        a.trigger("playBackgroundVideo")
                    }, e ? 50 : 0), e || t ? s.fadeIn(J.transitions.media.defaults.fadeOut) : s.css({
                        display: "block"
                    }), a.data(J.defaults.init.dataKey).mediaProperties.isPreloaded = !0)
                }
            },
            timers: {
                defaults: {
            ...
            load: function() {
                var e, a;
                J.o.plugins && 0 !== J.o.plugins.length ? (e = J.o.plugins[0], a = "object" == typeof e ? e.namespace : e, window._layerSlider.plugins[a] ? (J.plugins.init(a, e, !0), J.plugins.load()) : J.browser.usesFileProtocol || "object" != typeof e ? (J.browser.usesFileProtocol ? window.console && (console.error(J.defaults.slider.errorText, "Cannot load plugins on file:// protocol."), console.info("Please include the plugin files manually.")) : window.console && (console.error(J.defaults.slider.errorText, "Plugin files are missing!"), console.info('Plugin "' + a + '" has been added in slider init options, but the source files are not found on page.')), J.o.plugins.splice(0, 1), J.plugins.load()) : -1 === window._layerSlider.pluginsBeingLoaded.indexOf(a) ? -1 === window._layerSlider.pluginsLoaded.indexOf(a) && -1 === window._layerSlider.pluginsNotLoaded.indexOf(a) ? (window._layerSlider.pluginsBeingLoaded.push(a), ie.ajax({
                    url: -1 === e.js.indexOf(LS_nsProtocol || "http://") && -1 === e.js.indexOf("https://") ? (window._layerSlider.pluginsPath || window._layerSlider.scriptPath + "/../plugins/") + e.js : e.js,
                    dataType: "script",
                    success: function() {
                        J.plugins.init(e.namespace, e, !0), window._layerSlider.pluginsLoaded.push(a)
                    },
                    error: function(e, t, i) {
                        window.console && (console.error(J.defaults.slider.errorText, a, "plugin has not been loaded!"), console.error("Additional error info:", i)), window._layerSlider.pluginsNotLoaded.push(a)
                    },
                    complete: function() {
                        window._layerSlider.pluginsBeingLoaded.splice(window._layerSlider.pluginsBeingLoaded.indexOf(a), 1), J.plugins.load()
                    }
                })) : (J[a] || -1 !== window._layerSlider.pluginsNotLoaded.indexOf(a) ? J.o.plugins.splice(0, 1) : J.plugins.init(a, e), J.plugins.load()) : J.plugins.checkLoaded(a)) : J.slider.check.initialized()
            },
            init: function(e, t, i) {
                J.initializedPlugins[e] = new window._layerSlider.plugins[e](J, $, W, t.settings), window._layerSlider.checkVersions(J.initializedPlugins[e].pluginData.requiredLSVersion, J.plugin.version) ? (t.css && i && ie('<link rel="stylesheet" href="' + (-1 === t.css.indexOf(LS_nsProtocol || "http://") && -1 === t.css.indexOf("https://") ? (window._layerSlider.pluginsPath || window._layerSlider.scriptPath + "/../plugins/") + t.css : t.css) + '">').appendTo("head"), J.initializedPlugins[e].init && J.initializedPlugins[e].init()) : window.console && console.error(J.defaults.slider.errorText, e, "plugin has not been loaded! Required LayerSlider version:", J.initializedPlugins[e].pluginData.requiredLSVersion, "(you have:", J.plugin.version + ")"), J.o.plugins.splice(0, 1)
            },
            ...
            set: {
                ...
                styles: function() {
                    var e, t, i, a, s, r, o, n, l, d, c, p, u, h, m, f, g, y = J.slider,
                        v = $.parent(),
                        x = L.style,
                        w = window.getComputedStyle(L, null),
                        S = parseInt(L.clientWidth),
                        b = parseInt(L.clientHeight),
                        T = parseInt(v.width()),
                        k = parseInt(v.height()),
                        C = J.o.layersContainerWidth,
                        P = J.o.layersContainerHeight,
                        O = J.o.type.toLowerCase();
                    switch (J.debugMode && J.debug.add("group", "sliderInit.style"), J.o.width ? e = -1 == J.o.width.indexOf("%") ? parseInt(J.o.width) : J.o.width : x.width ? e = -1 == x.width.indexOf("%") ? parseInt(x.width) : x.width : 0 < C ? (e = C, J.debugMode && J.debug.add("warn", "sliderInit.noWidth", C)) : (e = S, J.debugMode && J.debug.add("warn", "sliderInit.noWidth2", S)), i = e, J.o.height ? t = -1 == J.o.height.indexOf("%") ? parseInt(J.o.height) : J.o.height : x.height ? t = -1 == x.height.indexOf("%") ? parseInt(x.height) : x.height : 0 < P ? (t = P, J.debugMode && J.debug.add("warn", "sliderInit.noHeight", P)) : (t = b, J.debugMode && J.debug.add("warn", "sliderInit.noHeight2", k)), a = t, s = "" !== x.maxWidth ? -1 !== x.maxWidth.indexOf("px") ? parseInt(x.maxWidth) : x.maxWidth : 0, void 0 === J.userInitOptions.type && (0 < C && 0 < P || "100%" === e && "100%" === t ? O = "fullsize" : C <= 0 && P <= 0 && (J.o.responsiveUnder <= 0 || 0 < J.o.responsiveUnder && J.o.sliderVersion) ? O = void 0 !== J.o.responsive && !1 === J.o.responsive ? "fixedsize" : "responsive" : 0 < J.o.responsiveUnder && (O = "fullwidth")), O) {
                        case "fullwidth":
                            -1 !== e.indexOf("%") && (J.debugMode && J.debug.add("warn", "sliderInit.percWidth", [O, e, S]), e = S), C <= 0 && (C = e, J.debugMode && J.debug.add("warn", "sliderInit.conWidth", [O, e])), J.o.responsiveUnder <= 0 && (J.o.responsiveUnder = C, J.debugMode && J.debug.add("warn", "sliderInit.fullwidth", C)), -1 !== t.indexOf("%") && (o = k / (100 / parseInt(t)), J.debugMode && J.debug.add("warn", "sliderInit.fullwidth2", [O, t, o]), t = o), P <= 0 && (P = t);
                            break;
                        case "fullsize":
                            -1 !== e.indexOf("%") && (r = 0 < C ? C : T, J.debugMode && J.debug.add("warn", "sliderInit.fullsize", [O, e, r, T, C]), e = r), C <= 0 && (C = e, J.debugMode && J.debug.add("warn", "sliderInit.conWidth", [O, e])), -1 !== t.indexOf("%") && (o = 0 < P ? P : M.height() / (100 / parseInt(t)), J.debugMode && J.debug.add("warn", "sliderInit.fullsize2", [O, t, o, M.height(), P]), t = o), P <= 0 && (P = t, J.debugMode && J.debug.add("warn", "sliderInit.conHeight", [O, t]));
                            break;
                        case "fixedsize":
                            break;
                        default:
                            J.userInitOptions.type = J.o.type = O = "responsive", (J.o.responsiveUnder = -1) !== e.indexOf("%") && (e = S, J.debugMode && J.debug.add("warn", "sliderInit.percWidth", [O, e, S])), -1 !== t.indexOf("%") && (e = b, J.debugMode && J.debug.add("warn", "sliderInit.responsive", [O, t, b])), J.debugMode && 0 < C && J.debug.add("warn", "sliderInit.conWidth2", [O, C]), J.debugMode && 0 < P && J.debug.add("warn", "sliderInit.conHeight2", [O, P])
                    }
                    if ($.addClass("ls-container ls-" + O), $.parent().addClass("ls-direction-fix"), J.userInitOptions.slideBGSize || "responsive" !== O || !J.userInitOptions.hasOwnProperty("sliderVersion") || J.userInitOptions.sliderVersion || (J.o.slideBGSize = "auto", J.debugMode && J.debug.add("warn", "sliderInit.bgCover", O)), J.o.slideBGSize = J.o.slideBGSize.replace("100% 100%", "stretch"), n = 0 < C ? C : e, l = 0 < P ? P : t, (d = "auto" === (g = L.style.marginLeft) ? "auto" : "" === g ? parseInt(w.getPropertyValue("margin-left")) : parseInt(L.style.marginLeft)) === (c = "auto" === (f = L.style.marginRight) ? "auto" : "" === f ? parseInt(w.getPropertyValue("margin-right")) : parseInt(L.style.marginRight)) && ("" === g && "" === f && (I = d, c = d = "auto"), $.css({
                            marginLeft: "auto",
                            marginRight: "auto"
                        })), p = "" !== x.paddingLeft ? parseInt(x.paddingLeft) : parseInt($.css("padding-left")), h = "" !== x.paddingRight ? parseInt(x.paddingRight) : parseInt($.css("padding-right")), u = "" !== x.paddingTop ? parseInt(x.paddingTop) : parseInt($.css("padding-top")), m = "" !== x.paddingBottom ? parseInt(x.paddingBottom) : parseInt($.css("padding-bottom")), v = "" !== x.borderLeftWidth ? parseInt(x.borderLeftWidth) : parseInt($.css("border-left-width")), g = "" !== x.borderRightWidth ? parseInt(x.borderRightWidth) : parseInt($.css("border-right-width")), f = "" !== x.borderTopWidth ? parseInt(x.borderTopWidth) : parseInt($.css("border-top-width")), x = "" !== x.borderBottomWidth ? parseInt(x.borderBottomWidth) : parseInt($.css("border-bottom-width")), y.initial = {
                            type: O,
                            width: e,
                            height: t,
                            originalWidth: i,
                            ...
                            skinWidth: p + h + v + g,
                            skinHeight: u + m + f + x
                        }, J.debugMode && (J.debug.add("log", "sliderInit.style", [e, t, i, a, C, P, parseInt(n / l * 100) / 100, 0 < s ? s : void 0, [d, c]]), I && J.debug.add("warn", "sliderInit.margin", I)), ie("#ls-global").length || (ie("html").attr("id") ? ie("body").attr("id") || ie("body").attr("id", "ls-global") : ie("html").attr("id", "ls-global")), "static" !== w.getPropertyValue("position") && "absolute" !== w.getPropertyValue("position") && (L.style.position = "relative"), J.o.insertSelector && $[J.o.insertMethod](J.o.insertSelector), J.slider.$hiddenWrapper = ie('<div class="ls-wp-container fitvidsignore ls-hidden" data-layerslider-uid="' + W + '"></div>').addClass($.attr("class")).prependTo("body"), J.slider.$innerWrapper = ie('<div class="ls-inner"></div>'), J.slider.$slideBGColorWrapper = ie('<div class="ls-slide-bgcolor"></div>').appendTo(J.slider.$innerWrapper), J.slider.$layersWrapper = ie('<div class="ls-layers"></div>').appendTo(J.slider.$innerWrapper), J.slider.$bgVideosWrapper = ie('<div class="ls-background-videos"></div>').appendTo(J.slider.$layersWrapper), J.slider.$slideBGWrapper = ie('<div class="ls-slide-backgrounds"></div>').appendTo(J.slider.$layersWrapper), J.slider.$innerWrapper.appendTo($), !0 === J.o.hideOnMobile && te.isMobile ? ($.addClass("ls-forcehide"), $.closest(".ls-wp-fullwidth-container").addClass("ls-forcehide"), J.o.autoStart = !1) : J.slider.check.showHide(), "sticky" === J.o.scene || "scroll" === J.o.scene) {
                        ...
                        $.parent().is("ls-scene-wrapper") ? $.parent().attr("data-scene", J.o.scene).attr("data-layerslider-uid", W) : $.wrap('<ls-scene-wrapper data-scene="' + J.o.scene + '" data-layerslider-uid="' + W + '"></ls-scene-wrapper>'), J.slider.$spacingWrapper = ie('ls-scene-wrapper[data-layerslider-uid="' + W + '"]'), $.attr("data-scene", J.o.scene)
                    } else J.slider.$spacingWrapper = $;
                    var I = J.slider.isScene && "scene" === J.o.globalBGFor ? J.slider.$spacingWrapper : J.slider.$innerWrapper,
                        w = !1; - 1 == J.o.globalBGColor.indexOf("gradient") ? I.css({
                        backgroundColor: J.o.globalBGColor
                    }) : (w = J.o.globalBGColor, J.o.globalBGColor = "transparent"), J.o.globalBGImage ? I.css({
                        backgroundImage: "url( " + J.o.globalBGImage + " )" + (w ? ", " + w : ""),
                        ...
                        backgroundImage: w
                    }), "transparent" != J.o.globalBGColor || !1 !== J.o.globalBGImage || w || I.css({
                        background: "none transparent"
                    }), (J.o.preventSliderClip && J.o.fitScreenWidth && ("fullwidth" === O || "fullsize" === O && "fitheight" !== J.o.fullSizeMode) || J.slider.isScrollScene || J.slider.isSticky) && $.parents(":not(body, html)").each(function() {
                ...
                options: function() {
                    ...
                    ie("html").find('meta[content*="WordPress"]').length && (J.meta.wpVersion = ie("html").find('meta[content*="WordPress"]').attr("content").split("WordPress")[1]), window.LS_Meta && window.LS_Meta.v ? J.meta.lswpVersion = window.LS_Meta.v : ie("html").find('script[src*="layerslider"]').length && -1 != ie("html").find('script[src*="layerslider"]').attr("src").indexOf("?") && (J.meta.lswpVersion = ie("html").find('script[src*="layerslider"]').attr("src").split("?")[1].split("=")[1]), "undefined" != typeof layerSliderTransitions && (J.t = ie.extend({}, layerSliderTransitions)), "undefined" != typeof layerSliderCustomTransitions && (J.ct = ie.extend({}, layerSliderCustomTransitions)), J.debugMode && ("undefined" != typeof layerCustomSliderTransitions ? (J.debug.add("log", "sliderInit.customTransitions", !1), "undefined" == typeof layerSliderTransitions && J.debug.add("warn", "sliderInit.slideTransitions")) : "undefined" == typeof layerSliderTransitions && J.debug.add("warn", "sliderInit.noSlideTransitions")), "number" == typeof J.o.parallaxCenterDegree && (J.transitions.layers.parallax.defaults.centerDegree = J.o.parallaxCenterDegree), "number" == typeof J.o.parallaxSensitivity && (J.transitions.layers.parallax.defaults.sensitive = J.o.parallaxSensitivity), J.o.parallaxCenterLayers && (J.transitions.layers.parallax.defaults.centerLayers = J.o.parallaxCenterLayers), J.o.scrollCenterLayers && (J.transitions.layers.scroll.defaults.centerLayers = J.o.scrollCenterLayers), J.slider.isSticky && (ie.extend(J.o, {
                        ...
                        pauseOnHover: !1,
                        autoStart: !1
                    }), te.isMobile && (J.o.pauseOnHover = !1), J.o.noContextMenu && $.on("contextmenu." + W, function() {
                        return !1
                    }), J.o.startInViewport && (J.slider.state.waitForGettingInViewport = !0, J.o.playByScroll && (J.slider.positionToViewport = te.scroll.top > J.slider.offset.top - (te.viewport.height - J.slider.height) / 2 ? "under" : "over", t = !0, i = 4 * J.o.playByScrollSpeed, J.device.scroll.timeout = 250, J.transitions.layers.timeline.timeScaleModifier = 0, ie(document).on("wheel." + W + " touchmove." + W, function(e) {
                        te.isMobile ? (a = e.originalEvent.touches[0].clientY, s < a ? J.device.scroll.direction = "up" : a < s && (J.device.scroll.direction = "down"), r = s - a, s = a) : (0 < e.originalEvent.deltaY ? J.device.scroll.direction = "down" : J.device.scroll.direction = "up", r = e.originalEvent.deltaY), 0 !== Math.abs(r) && (J.device.scroll.lastDirection ? J.device.scroll.lastDirection !== J.device.scroll.direction && (J.device.scroll.lastDirection = J.device.scroll.direction, J.transitions.layers.timeline.timeScaleModifier = 0) : J.device.scroll.lastDirection = J.device.scroll.direction, "inside" === J.slider.positionToViewport && (J.resize.viewport(), 0 <= r ? J.transitions.layers.timeline.scrollForward() : J.transitions.layers.timeline.scrollBackwards(), t && (clearTimeout(J.timeouts.scroll), t = !1, J.transitions.layers.timeline.timeScaleModifier = J.transitions.layers.timeline.timeScaleModifier < i ? J.transitions.layers.timeline.timeScaleModifier + .25 : i, J.timeouts.scroll2 = setTimeout(function() {
                ...
                pictureElements: function() {
                    for (var e = $.find("picture"), t = $.find("source"), i = 0, a = t.length; i < a; i++) {
                        var s = ie(t[i]);
                        !s.attr("src") && s.attr("data-src") && s.attr("src", s.attr("data-src")), !s.attr("srcset") && s.attr("data-srcset") && s.attr("srcset", s.attr("data-srcset"))
                    }
                    for (var r = 0, o = e.length; r < o; r++) {
                        var n, l, d, c = ie(e[r]);
                        c.is(".ls-bg, .ls-tn") ? (l = (n = c.find("img"))[0], d = c.attr("class"), !n.attr("src") && n.attr("data-src") && n.attr("src", "data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="), !n.attr("srcset") && n.attr("data-srcset") && n.attr("srcset", n.attr("data-srcset")), n.attr("data-src", l.currentSrc || n.attr("data-src") || n.attr("src")), n.removeAttr("width height src srcset").addClass(d).prependTo(n.closest(".ls-slide")), c.remove()) : c.find("img").appendTo(c).removeAttr("width height data-ls")
                    }
                },
                events: function() {
                    M.on("scroll." + W, function() {
                        J.slider.set.offset()
                    }), M.on("touchmove." + W, function(e) {
                        e = e.touches || e.originalEvent.touches;
                        1 == e.length && (self.touchX = e[0].clientX)
                    }), M.on("resize." + W, function() {
                        J.slider.check.showHide(), J.transitions.scrollscene.immediateRender = !0, "inside" === J.slider.positionToViewport && J.o.playByScroll && J.resize.viewport(), J.slider.shouldResize && (!te.isMobile || te.isMobile && te.viewport.width !== te.viewport.lastWidth || J.slider.isPopup) && J.resize.all(), J.slider.set.offset(), J.slider.isScene && J.resize.scene(), J.slider.isPopup || (J.timeouts.resize && clearTimeout(J.timeouts.resize), J.resize.once ? J.resize.once = !1 : J.timeouts.resize = setTimeout(function() {
                            J.resize.once = !0, M.trigger("resize." + W), J.api.methods("resetScroll")
                        }, 100))
                    }), J.debugMode && (M.off(".debug" + W), M.on("resize.debug" + W, function() {
                        J.debug.add("log", "resize.window", te.viewport.width, !0)
                    })), M.on("hashchange." + W, function() {
                        document.location.hash && J.slides.deeplink(document.location.hash)
                    }), J.slider.set.offset(), M.trigger("resize." + W), J.o.refreshWaypoint && window.Waypoint && Waypoint.refreshAll()
                },
                offset: function() {
                    if ("none" !== $.css("display")) {
                        ...
                        if (J.slider.get.offset(e), J.slider.get.position(e), 0 < J.slider.position.left - te.viewport.width ? J.slider.position.left - te.viewport.width > J.performance.threshold ? J.slider.position.toViewportX = "after" : J.slider.position.toViewportX = "insideLimit" : J.slider.position.right < 0 ? J.slider.position.right < -J.performance.threshold ? J.slider.position.toViewportX = "before" : J.slider.position.toViewportX = "insideLimit" : J.slider.position.toViewportX = "inside", 0 < J.slider.position.top - te.viewport.height ? J.slider.position.top - te.viewport.height > J.performance.threshold ? J.slider.position.toViewportY = "below" : J.slider.position.toViewportY = "insideLimit" : J.slider.position.bottom < 0 ? J.slider.position.bottom < -J.performance.threshold ? J.slider.position.toViewportY = "above" : J.slider.position.toViewportY = "insideLimit" : J.slider.position.toViewportY = "inside", J.slider.position.toViewportYForSkipViewportLayers = J.slider.position.toViewportY, J.slider.state.waitForGettingInViewport && (J.slider.position.middle < te.viewport.height && 0 < J.slider.position.middle ? ((J.slider.position.toViewportY = "inside") === J.slider.position.toViewportX && (J.slider.position.toViewport = "inside"), J.slider.state.waitForGettingInViewport = !1, J.transitions._slideTimeline && J.transitions._slideTimeline.play(), J.o.animateFirstSlide && J.slideshow.firstStart && J.slider.state.readyForStart && (J.resize.layers({
                            ...
                            J.transitions.scrollscene.stickLimit = a, J.slider.wrapperPosition = {
                                left: t.left,
                                top: t.top,
                                ...
                                width: t.width,
                                height: t.height
                            }, J.slider.state.shouldAnimateScrollSnene = !1, t.top > a ? ("disabled" !== J.slider.state.sticky || J.slider.isScrollScene && !J.transitions.scrollscene.initialized) && (J.slider.state.sticky = "disabled", J.slider.state.shouldAnimateScrollSnene = !0) : t.bottom - J.slider.height - a < 0 ? ("over" !== J.slider.state.sticky || J.slider.isScrollScene && !J.transitions.scrollscene.initialized) && (J.slider.state.sticky = "over", J.slider.state.shouldAnimateScrollSnene = !0) : t.top <= a && t.bottom > -a && ("enabled" !== J.slider.state.sticky && (J.slider.state.sticky = "enabled"), J.slider.state.shouldAnimateScrollSnene = !0), J.slider.isScrollScene && J.transitions._slideTimeline && J.slider.state.shouldAnimateScrollSnene && J.transitions.scrollscene.animate()
                        }
            ...
            get: {
                ...
                scrollTop: function(e, t) {
                    var i = parseFloat(e.offset().top) + (t.offset || 0);
                    switch (t.scrollposition) {
                        default:
                            case "top":
                            break;
                        case "middle":
                                i = i - window._lsData.viewport.height / 2 + e.height() / 2;
                            break;
                        case "bottom":
                                i = i + e.height() - window._lsData.viewport.height
                    }
                    return i
                }
            },
            check: {
                initialized: function() {
                    J.debugMode && J.debug.add("log", "sliderInit.info", [J.plugin.version, J.plugin.releaseDate, J.userInitOptions.sliderVersion || "n/a or slider version is pre 6.0.0", $.attr("id"), W, ie.fn.jquery, J.meta.lswpVersion, J.meta.wpVersion], !0), J.slider.initialized || (J.slider.initialized = !0, this.skins())
                },
                skins: function() {
            ...
            init: function() {
                clearTimeout(J.timeouts.skinLoad1), clearTimeout(J.timeouts.skinLoad2), clearTimeout(J.timeouts.skinLoad3), clearTimeout(J.timeouts.skinLoad4), J.slider.set.styles(), J.slider.set.options(), J.slider.set.pictureElements(), J.slides.init(), J.device.fullscreen.set(), J.media.init(), J.gui.timers.init(), J.gui.loadingIndicator.init(), J.preload.init(), J.gui.shadow.init(), J.navigation.init(), J.slideshow.init(), J.slides.set.firstSlide(), J.gui.navigation.init(), J.gui.media.init(), J.resize.slider(), J.yourLogo.init(), J.slider.set.events(), J.api.hasEvent("sliderDidLoad") && J.api.triggerEvent("sliderDidLoad", J.api.eventData()), J.functions.setStates(J.slider, {
                    isLoaded: !0
                }), J.slider.state.shouldBeDestroyed ? J.api.methods("destroy") : (J.slider.isPopup || (J.intervals.checkSliderVisibility = setInterval(function() {
            ...
            convert: {
                ...
                nodesTransformOrigin: function(e, d, c, t) {
                    for (var i = "object" == typeof e, p = (d.length, []), u = t[0].style, h = ["left", "top"], a = function(e, t) {
                            for (var t = ie(d[t]), i = parseInt(t.css("font-size")), a = t.position(), s = (n = ie.trim(e)).split(" "), r = "", o = [J.slider.width, J.slider.height], n = J.functions.convert.specialValuesOfTransformOrigin(n), l = 0; l < n.length; l++) - 1 !== s[l].indexOf("slider") ? (J.transitions.layers.timeline.shouldRestart = !0, r += l < 2 ? o[l] / (100 / parseInt(n[l])) - parseInt(a[h[l]]) - parseInt(u[h[l].toLowerCase()]) + "px " : "0px") : -1 !== n[l].indexOf("%") ? r += n[l] + " " : -1 !== n[l].indexOf("em") ? r += parseFloat(n[l]) * i + "px " : r += parseInt(n[l]) * c.settings.calculatedratio + "px ";
                            p.push(ie.trim(r))
                        }, s = 0, r = i && e.length, o = 0; o < d.length; o++) i ? (a(e[s], o), ++s == r && (s = 0)) : a(e, o);
                    return p
                },
                easing: function(e, t) {
                    return "string" != typeof e ? e : (-1 !== (e = e.toLowerCase()).indexOf("swing") || -1 !== e.indexOf("linear") ? i = ee.Linear.easeNone : (a = e.match(/(easeinout|easein|easeout)(.+)/)[2], a = ee[a.charAt(0).toUpperCase() + a.slice(1)], -1 !== e.indexOf("easeinout") ? i = a.easeInOut : -1 !== e.indexOf("easeout") ? i = t ? a.easeIn : a.easeOut : -1 !== e.indexOf("easein") && (i = t ? a.easeOut : a.easeIn)), i);
                    var i, a
                },
                transition: function(e, t, i, a) {
                    ...
                    }), "after" === i ? s.scaleX = s.scaleY = s.scaleZ = 1 : s.scale3d !== a && (s.scaleX = s.scaleY = s.scaleZ = s.scale3d, delete s.scale3d), s.delay && (s.delay = "after" === i ? s.delay / 1e3 : s.delay), void 0 === t && (t = "easeInOutQuart"), s.ease = J.functions.convert.easing(t), s
                },
                ...
                _properties: function(e, t) {
                    ...
                    for (var i = e.split(J.defaults.init.staggerSplitChar), a = [], s = 0; s < i.length; s++) a[s] = ie.isNumeric(i[s]) ? parseFloat(ie.trim(i[s])) : ie.trim(i[s]);
                    return a
                },
                ...
                randomProperties: function(e, t, i, a) {
                    var i = i || !1,
                        a = a || !!i && i.data(J.defaults.init.dataKey),
                        s = "Width",
                        r = !1; - 1 === t.indexOf("height") && -1 === t.indexOf("top") && -1 === t.indexOf("y") || (s = "Height"), -1 === t.indexOf("duration") && -1 === t.indexOf("delay") && -1 === t.indexOf("start") && -1 === t.indexOf("scale") && -1 === t.indexOf("opacity") && -1 === t.indexOf("rotat") && -1 === t.indexOf("skew") || (r = !0), -1 !== e.indexOf("random") && -1 !== e.indexOf("(") && -1 !== e.indexOf(",") && -1 !== e.indexOf(")") ? e = e.split("(")[1].split(")")[0].replace(",", J.defaults.init.rangeSplitChar) : e.charAt(0) === J.defaults.init.openingBracket && e.charAt(e.length - 1) === J.defaults.init.closingBracket && (e = e.substring(1, e.length - 1)), e = e.replace(/,/g, ".").replace(/٫/g, ".");
                    var o, n = -1 === t.indexOf("scale") && -1 === t.indexOf("opacity") ? 1 : 100,
                        l = e;
                    return -1 !== e.indexOf(J.defaults.init.randomSplitChar) ? l = (l = (o = e.split(J.defaults.init.randomSplitChar))[Math.floor(Math.random() * o.length)].trim()).charAt(0) === J.defaults.init.openingBracket && l.charAt(l.length - 1) === J.defaults.init.closingBracket ? J.functions.convert.randomProperties(l, t, i, a) : parseFloat(i ? J.resize.getXY(i, a, l, s, r) : l) : -1 !== e.indexOf(J.defaults.init.rangeSplitChar) && ((o = e.split(J.defaults.init.rangeSplitChar))[0] = parseFloat((i ? J.resize.getXY(i, a, o[0], s, r) : o[0]) * n), o[1] = parseFloat((i ? J.resize.getXY(i, a, o[1], s, r) : o[1]) * n), o.sort(function(e, t) {
                        return e - t
                    }), l = Math.floor(Math.random() * (o[1] - o[0] + 1) + o[0]) / n), l
                },
                clipProperties: function(e, t, i, a) {
                    if (-1 !== e.indexOf("polygon") && -1 === e.indexOf("clip") && -1 === e.indexOf("px") && -1 === e.indexOf(", ")) return e;
                    for (var s, r, o = e, n = -1 === (e = -1 !== e.indexOf("(") ? ie.trim(e.split("(")[1].split(")")[0]) : ie.trim(e)).indexOf(",") ? e.split(" ") : e.split(","), l = [
                            ["0%", "0%"],
                            ["100%", "0%"],
                            ["100%", "100%"],
                            ["0%", "100%"]
                        ...
                        }, u = a && -1 !== o.indexOf("rect") ? 0 : 100, h = 0; h < n.length; h++)
                        if (-1 === (s = n[h].trim()).indexOf(" ")) {
                            if ("number" == typeof parseInt(s)) switch (0 === parseInt(s) && (s = "0%"), h) {
                                case 0:
                                    -1 === s.indexOf("%") && (s = p(parseInt(s) / (c / 100)) + "%"), l[0][1] = s, l[1][1] = s;
                                    break;
                                case 1:
                                    -1 !== s.indexOf("%") ? (l[1][0] = 100 - parseInt(s) + "%", l[2][0] = 100 - parseInt(s) + "%") : (-1 === s.indexOf("%") && (s = p(Math.abs(parseInt(s) / (d / 100) - u)) + "%"), l[1][0] = s, l[2][0] = s);
                                    break;
                                case 2:
                                    -1 !== s.indexOf("%") ? (l[2][1] = 100 - parseInt(s) + "%", l[3][1] = 100 - parseInt(s) + "%") : (-1 === s.indexOf("%") && (s = p(Math.abs(parseInt(s) / (c / 100) - u)) + "%"), l[2][1] = s, l[3][1] = s);
                                    break;
                                case 3:
                                    -1 === s.indexOf("%") && (s = p(parseInt(s) / (d / 100)) + "%"), l[0][0] = s, l[3][0] = s
                            }
                        } else -1 === (r = s.split(" "))[0].indexOf("%") && (r[0] = p(parseInt(r[0]) / (d / 100)) + "%"), l[h][0] = r[0], -1 === r[1].indexOf("%") && (r[1] = p(parseInt(r[1]) / (c / 100)) + "%"), l[h][1] = r[1];
            ...
            getSliderClosestParentElementWithNumericValueOfProperty: function(e) {
                for (var t, i = $.parents().not(".ls-fullscreen-wrapper"), a = i.length, s = 100, r = 0; r < a; r++)
                    if ("auto" !== (t = window.getComputedStyle(i[r]).getPropertyValue(e))) {
                        if (-1 !== t.indexOf("px") && (0 < parseInt(t) || J.slider.isPopup)) return J.slider.$parentWithNumericWidthValue = ie(i[r]), ie(i[r]); - 1 !== t.indexOf("%") && (s = s / 100 * parseInt(t), J.slider.$parentWithNumericWidthValuePercent = s)
                    }
            },
            sortArray: function(e, t, i) {
                ...
                switch (i) {
                    case "forward":
                        for (a = 0; a < e; a++)
                            for (s = 0; s < t; s++) c.push(a + s * e);
                        break;
                    case "reverse":
                        for (a = e - 1; - 1 < a; a--)
                            for (s = t - 1; - 1 < s; s--) c.push(a + s * e);
                        break;
                    case "center":
                    ...
                    case "mirror":
                        ...
                        break;
                    case "radial-out":
                        for (l = e / 2, d = t / 2, a = 0; a < e; a++)
                            for (s = 0; s < t; s++) c.push(Math.floor(Math.abs(d - s - .5)) + Math.floor(Math.abs(l - a - .5)));
                        break;
                    case "radial-in":
                        for (l = e / 2, d = t / 2, a = 0; a < e; a++)
                            for (s = 0; s < t; s++) c.push(Math.floor(d - Math.ceil(Math.abs(d - s - .5))) + Math.floor(l - Math.ceil(Math.abs(l - a - .5))))
                }
                return c
            },
            ...
            clearEvents: function() {
                M.add("body").add(document).add($).add($.find("*")).add("." + W).off("." + W + " .debug" + W + " .parallax" + W + " .scroll" + W), window._layerSlider.closePopupsOnEsc && window._layerSlider.closePopupsOnEsc[W] && delete window._layerSlider.closePopupsOnEsc[W], delete window._layerSliders[W], $.off()
            }
        }, J.device = {
            scroll: {
            ...
            fullscreen: {
                ...
                set: function() {
                    J.o.allowFullscreen && (document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled) && ($.wrap('<div class="ls-fullscreen-wrapper"></div>'), J.slider.$fullscreenWrapper = $.closest(".ls-fullscreen-wrapper"), J.slider.fullscreenWrapper = J.slider.$fullscreenWrapper[0], J.slider.$spacingWrapper = J.slider.$fullscreenWrapper, J.slider.fullscreenWrapper.requestFullscreen = J.slider.fullscreenWrapper.requestFullscreen || J.slider.fullscreenWrapper.webkitRequestFullscreen || J.slider.fullscreenWrapper.mozRequestFullScreen || J.slider.fullscreenWrapper.msRequestFullscreen, document.exitFullscreen = document.exitFullscreen || document.webkitExitFullscreen || document.mozCancelFullScreen || document.msExitFullscreen, ie(document).on("fullscreenchange." + W + " webkitfullscreenchange." + W + " mozfullscreenchange." + W + " msfullscreenchange." + W, function() {
                        J.device.fullscreen.element() || J.device.fullscreen.exit()
                    }), J.slider.$fullscreenWrapper.on("dblclick." + W, function() {
            ...
            do: function(t) {
                ...
                switch (t.action) {
                    ...
                    case "scrollToTimelinePosition":
                        ...
                        else if ("scrollToPrevProject" === t.action) 0 !== l.index(p) ? (c = l.eq(l.index(p) - 1), v = J.slider.get.scrollTop(c, t)) : a = "There’s no previous project to scroll to.";
                        else if ("scrollToNextProject" === t.action) l.index(p) < l.length - 1 ? (c = l.eq(l.index(p) + 1), v = J.slider.get.scrollTop(c, t)) : a = "There’s no next project to scroll to.";
                        else if (-1 !== t.action.indexOf("scrollToElement")) {
                            try {
                                c = ie(t.selector.toString()).not(".ls-wp-container.ls-hidden")
                            } catch (e) {
                                s = e
                            }
                            c.length ? ((n = c.closest("ls-scene-wrapper")).length && (c = n), v = J.slider.get.scrollTop(c, t)) : a = 'Couldn’t find the scroll target element "' + t.selector + '". Please verify the selector you’ve entered.'
                        } else if ("scrollToScenePosition" === t.action) {
                            switch (t.target) {
                                case "currentScene":
                                    J.slider.isScene ? c = p : a = "Current project is not a scene.";
                                    break;
                                case "nextScene":
                                    h + 1 < u ? c = ie(d[h + 1]) : a = "There are no next scenes in the DOM.";
                                    break;
                                case "previousScene":
                                    0 <= h - 1 ? c = ie(d[h - 1]) : a = "There are no previous scenes in the DOM."
                            }
                            c.length && (r = parseFloat(c.attr("data-scene-duration")), o = c.height(), n = (l = c.find(".ls-container")).height(), t.position = ie.trim(t.position) || "0ms", v = c.is('[data-scene="scroll"]') ? (m = -1 !== t.position.indexOf("%") || -1 === t.position.indexOf("ms") ? r * (Math.min(100, Math.max(0, parseFloat(t.position))) / 100) : Math.min(Math.max(0, parseFloat(t.position) / 1e3), r), Math.round(parseFloat(c.offset().top) - parseFloat(l.css("top")) + m / r * (o - n))) : (m = Math.min(100, Math.max(0, parseFloat(t.position))) / 100, Math.round(parseFloat(c.offset().top) - parseFloat(l.css("top")) + (o - n) * m)))
                        ...
                        a || (t.duration = ie.isNumeric(t.duration) ? t.duration : 1e3, "scrollToTimelinePosition" === t.action ? J.transitions._slideTimeline.tweenTo(g, {
                    ...
                    case "stopSlideshow":
                    case "startSlideshow":
                        "nextSlide" === t.action && (x = "next"), "prevSlide" === t.action && (x = "prev"), "lastSlide" === t.action && (x = "last"), "firstSlide" === t.action && (x = "first"), "stopSlideshow" === t.action && (x = "stop"), "startSlideshow" === t.action && (x = "start"), J.navigation[x]("clicked");
                        break;
                    case "replaySlide":
                        J.api.methods("replay");
                        break;
                    ...
                    case "unmuteMedia":
                        ...
                        break;
                    case "openPopup":
                        var y, v = ie('[data-ls-slug="' + t.popup + '"], [id^=layerslider_' + t.popup + "]").first(),
                            x = v.data("lsSliderUID");
                        v.length ? ((y = window._layerSliders[x].initializedPlugins.popup).plugin.settings.showOnce = !1, "opened" == y.state.is ? t.toggle && y.events.hide() : t.slide ? v.layerSlider("fastChangeTo", t.slide, function() {
                            y.events.show()
                        }) : y.events.show()) : (v = {
                    ...
                    case "jsFunction":
                        try {
                            ...
                            s = e, a = "The browser thrown the following error after calling " + t.function+"() JavaScript function."
                        }
                }
                a && console.error('LayerSlider: Error while calling layer action "' + t.action + '". ' + a + ("" !== s ? "\n\r\n\r" : ""), s)
            }
        }, J.api = {
            ...
            methods: function(e, t, i, a) {
                ...
                switch (e) {
                    ...
                    case "launchPopups":
                        ...
                        break;
                    case "fastChangeTo":
                        t && ie.isNumeric(t) && (J.slides.current.index !== t ? (J.slideshow.forceFastChange = !0, J.slider.shouldResize = !0, i && "function" == typeof i && (J.slideshow.forceFastChangeCallback = i), J.slideshow.changeTo(t, !0, !0)) : i && i());
                        break;
                    case "resetScroll":
                        J.slider.set.offset(), M.trigger("scroll.scroll" + W).trigger("touchmove.scroll" + W).trigger("scroll.parallax" + W).trigger("touchmove.parallax" + W);
                        break;
                    case "enableScene":
                    ...
                    case "resume":
                        ...
                        }), J.transitions.layers.parallax.state.paused = !1, J.transitions.layers.scroll.state.paused = !1, J.transitions._slideTransition ? J.transitions._slideTransition.play() : J.o.animateFirstSlide && J.slideshow.firstStart && J.slider.state.readyForStart && (J.resize.layers({
                            callback: J.api.resumeCallback
                        }), J.api.resumeCallback = !1), t && "performanceMode" === t && J.functions.setStates(J.slideshow, {
                        ...
                        if (J.slider.state.isLoaded) {
                            if (J.functions.clearTimers(), J.functions.clearTimelines(), J.layers.$all.removeData(), J.api.hasEvent("sliderDidDestroy") && J.api.triggerEvent("sliderDidDestroy"), J.slider.state.sholudBeRemoved || t) {
                                if (J.slider.$hiddenWrapper.remove(), J.gui.timers.slidebar.$containerElement)
                                    for (var s = 0; s < J.gui.timers.slidebar.$containerElement.length; s++) J.gui.timers.slidebar.$containerElement[s] instanceof jQuery && J.gui.timers.slidebar.$containerElement[s].remove();
                            ...
                            J.functions.clearEvents(), window._layerSlider.removeSlider(W)
            ...
            triggerEvent: function(t, e) {
                ...
                return null != a ? a : "undefinded" != typeof i && null !== i ? i : void 0
            }
        }, J.browser = {
            ...
            supports3D: function() {
                for (var e = ie("<div>"), t = !1, i = !1, a = ["perspective", "OPerspective", "msPerspective", "MozPerspective", "WebkitPerspective"], s = ["transformStyle", "OTransformStyle", "msTransformStyle", "MozTransformStyle", "WebkitTransformStyle"], r = a.length - 1; 0 <= r; r--) t = t || void 0 !== e[0].style[a[r]];
